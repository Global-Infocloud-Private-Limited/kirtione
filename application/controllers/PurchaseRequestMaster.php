...
class PurchaseRequestMaster extends ClientsController
{
...
//================== Load Purchase Request Page Vendor Panel ===================
    public function index()
    {
        ...
        $this->data($data);
        $this->view('PurchaseRequestMaster/PurchaseRequestList');
        $this->layout();
    }
//=================== Get Vendor Purchase Request data =========================
    public function GetPurchaseRequestList()
	{
        ...
        $result = $this->PurchaseModel->GetPurchaseRequestData($data); 
    	...
    	{
    	        $url = base_url()."PurchaseRequestMaster/PurchaseRequestDetails/".$value["PurchID"];
	...
	public function PurchaseRequestDetails($id)
	{
		...
		$data['PurchaseRequestData'] = $this->PurchaseModel->GetPurchaseRequestPrNoWiseData($id);	
		...
		$data['title'] = "Purchase Request Details";
        $this->data($data);
        $this->view('PurchaseRequestMaster/PurchaseRequestDetails');
        $this->layout();
	}
