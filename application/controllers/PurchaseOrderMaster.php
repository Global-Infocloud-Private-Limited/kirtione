...
class PurchaseOrderMaster extends ClientsController
{
    ...
    public function index()
    {
        ...
        $this->data($data);
        $this->view('PurchaseOrderMaster/PurchaseOrderLists');
        $this->layout();
    }
//====================== Get Vendor Purchase Order List ========================
    public function GetPurchaseOrderList()
	{
        ...
        $result = $this->PurchaseModel->GetPurchaseOrderData($data); 
    	...
    	{
    	    $url = base_url()."PurchaseOrderMaster/PurchaseOrderDetails/".$value["PurchID"];
            ...
            $html .= '<td style="text-align:center;">'._d(substr($value["PRDate"],0,10)).'</td>';   
	...
	public function PurchaseOrderDetails($id)
	{
		...
		$data['PurchaseOrderdata'] = $this->PurchaseModel->GetPurchOrderDataPoWise($id);	
        ...
        $this->data($data);
        $this->view('PurchaseOrderMaster/PurchaseOrderDetails');
        $this->layout();
	}
	
	public function GetPurchOrderDetails()
	{
