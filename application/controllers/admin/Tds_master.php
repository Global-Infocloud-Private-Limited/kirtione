...
class Tds_master extends AdminController
{
    ...
    {
        if (!has_permission_new('tds_master', '', 'view')) {
            access_denied('TDS Master');
        }
        ...
        $data['title'] = 'TDS Master';
        $data['parameters'] = $this->invoice_items_model->get_parameters_data();
        
        $this->load->view('admin/tds_master/manageNew', $data);
    }
