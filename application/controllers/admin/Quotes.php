...
class Quotes extends CI_Controller
{
    ...
    function subscribe()
    {
        $this->load->view('admin/content/site_subscribe');
    }
    ...
    function send_message(){
        ...
        $fields = array(
            'app_id' => "6a810bb7-f688-4b3f-b2bb-c88de1fe4f87",
        ...
        curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json; charset=utf-8',
            'Authorization: Basic OWVlYjAwZTUtNDJlZS00Y2IxLTk2MGUtOGQwYzExZDVhNDcw'));
