...
//====================== VERYFIED CODE =========================================
    ...
    public function SubGroup1()
    {
        ...
        $data['AccountSubGroupID1'] = $this->accounts_master_model->GetAccountSubGroupID1New();
    ...
    public function SubGroup2()
    {
        ...
        $data['AccountMainGroup'] = $this->accounts_master_model->GetMainGroup();
        $data['AccountMainGroup1'] = $this->accounts_master_model->GetMainGroup1();
    ...
    {
        $data = array(
            'SubActGroupID1'=>str_pad($this->input->post('SubGroupID'), 6, '0', STR_PAD_RIGHT),
    ...
    public function SaveSubGroup()
    {
        $data = array(
            ...
            'SubActGroupName'=>$this->input->post('SubGroupName'),
            'SubActGroupID1'=>$this->input->post('SubGroupID1'),
        );
    ...
    {
        $data = array(
            'SubActGroupID2'=>$this->input->post('SubGroupID'),
            'SubActGroupName'=>$this->input->post('SubGroupName'),
    ...
    public function GetActSubGroupID2ByActSubGroup1()
    {
        $AccountSubGroupID1 = $this->input->post('AccountSubGroupID1');
        $account_data = $this->accounts_master_model->GetActSubGroupID2ByActSubGroup1($AccountSubGroupID1);
        echo json_encode($account_data);
    }
...
//=========================== VERYFIED CODE END ================================
    ...
    public function AddEditAccountHead($accountId = '')
    {
        ...
        $data['title'] = "Add/Edit Account Head";
        $data['company_detail'] = $this->accounts_master_model->get_company_detail();
        $data['AccountSubGroups'] = $this->accounts_master_model->GetAccountSubGroupID1New();
    ...
    {
        $AccountLedger = $this->accounts_master_model->GetAccountList();
    ...
    public function GetAccountDetailByID()
    {
        ...
        $AccountDetails = $this->accounts_master_model->GetAccountDetails($AccountID);
    ...
    public function UpdateAccountID()
    {
        $data = array(
            ...
            'SubActGroupID1'=>$this->input->post('SubActGroupID1'),
            'AccountSubGroupID2'=>$this->input->post('AccountSubGroupID2'),
        ...
        $AccountDetails         = $this->accounts_master_model->UpdateAccountID($data);
        echo json_encode($AccountDetails);
    }
    ...
    public function SaveItemID()
    {
        ...
        $AccountDetails                  = $this->accounts_master_model->SaveAccountID($data);
  ...
  public function get_account_group_details()
    ...
    public function User_master()
    {
        ...
        if ($this->input->post()) {
            ...
            if (!has_permission_new('user_master', '', 'create')) {
            access_denied('Invoice Items');
            }
            $data = $this->input->post();
            $selected_company = $this->session->userdata('root_company');
