<?php
	...
	class Traceability extends AdminController
	{
        ...
        public function TraceabilityDashboard()
		{
		    if (!has_permission_new('Traceability_Dashboard', '', 'view')) {
				access_denied('TraceabilityDashboard'); 
			}
			
			$this->load->model('Traceability_model');
			$data['title']  = "Traceability Dashboard";
			
		    $this->load->view('admin/Traceability/TraceabilityDashboard',$data);
		}
	}