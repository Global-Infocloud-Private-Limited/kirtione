...
class DirectSaleinvoice_pdf extends App_pdf
{
    protected $invoice;
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/DirectSaleinvoicepdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/DirectSaleinvoicepdf.php';
		// $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/k1saleinvoicepdf.php';
        // $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/k1saleinvoicepdf.php';
