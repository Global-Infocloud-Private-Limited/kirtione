<script>
    ...
    var hotSettings = {
      ...
      height:'400px',
		...
		maxRows: 150,
		rowHeaders: true,
		colWidths: [100,80,80, 60, 60, 70,70,50,70, 60, 80,50,50,50,50,70],
		colHeaders: [
		...
		if(changes !== null){
			...
			{			 
				...
				else if(prop == 'Discount')
				{
					...
					let discount = hot.getDataAtCell(row, 10); 	
					if(discount > rate){
					    alert("Please add discount is less than or equal to rate");
					    hot.setDataAtCell(row, 10, 0);
					    discount = 0;
					}
					//hot.setDataAtCell(row, 8, discount); 
