            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group" app-field-wrapper="AccountID">
                  ...
                  <select name="centerid" id="centerid" class="selectpicker form-control"
              ...
              <div class="col-md-3">
                <div class="form-group" app-field-wrapper="itemid">
                  ...
                  <select name="itemid" id="itemid" class="selectpicker form-control"
                    data-none-selected-text="Non Selected" data-live-search="true" disabled>
                    <option value="">All</option>
                    <?php
              ...
              <div class="col-md-2">
                <div class="form-group" app-field-wrapper="AccountID">
                  ...
                  <select name="entrytype" id="entrytype" class="selectpicker form-control"
                    data-none-selected-text="Non Selected" data-live-search="true">
              ...
              <div class="col-md-3">
                <div class="form-group" app-field-wrapper="AccountID">
                  ...
                  <select name="AccountID" id="AccountID" class="selectpicker form-control"
                    data-none-selected-text="Non Selected" data-live-search="true">
                    <option value="">All</option>
                    <?php
              ...
              <div class="col-md-9" style="margin-top:10px;">
                ...
                ?>
                <button class="btn btn-info pull-left mleft5 search_data" style="margin-right:10px;"
                ...
                <div class="custom_button">
                  ...
                  <a class="btn btn-default buttons-excel buttons-html5" tabindex="0"
                    aria-controls="table-purchase_request" href="#" id="caexcel"><span>Export to excel</span></a>
                  <?php
                    }
                  ?>
                  <?php
                  ...
                  ?>
                  <a class="btn btn-default" href="javascript:void(0);" style="margin-left:10px;"
...
<script>
  $(document).ready(function () {
    ...
    function load_data() {
      ...
      $.ajax({
        url: "<?php echo admin_url(); ?>PurchaseMaster/GetFilterPurchaseList",
        method: "POST",
...
<script type="text/javascript">
  function printPage() {
    ...
    var reporttype;
    var Report_type = $("#reporttype").val();
    if (Report_type == 1) { reporttype = "Bill Wise"; }
    else if (Report_type == 2) { reporttype = "Item Wise"; }
...
<script>
  $("#caexcel").click(function () {
    ...
    $.ajax({
      ...
      method: "POST",
      data: {
        order_statusText: order_statusText, Partyname: Partyname, Centertext, Centertext, ReportTypetext: ReportTypetext, ItemName: ItemName, ItemID: ItemID, Report_type: Report_type, AccountID: AccountID,
