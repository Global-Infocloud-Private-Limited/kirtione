              ...
              <div class="col-md-12">
                <nav aria-label="breadcrumb" >
                  <ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><b>Purchase Return Report</b></li>
                  </ol>
                </nav>
...
$(document).ready(function(){  
  ...
  function load_data(){
    ...
    $.ajax({
      url:"<?php echo admin_url(); ?>PurchaseMaster/GetPurchaseReturnReportFilterData",
      method:"POST",
      data:{from_date, to_date, order_status, AccountID, CenterID, ItemID, Report_type, Entry_type},
      beforeSend: function() {
...
<script type="text/javascript">
    function printPage()
    {
        ...
        heading_data += '<tr>';
        heading_data += '<td style="text-align:center;"colspan="3">Purch Return Report : From : ' + from_date + ', To : ' + to_date + ', Center Name : ' + center + ', Report Type : ' + reporttype + ', Party Name : ' + party + '</td>';
        heading_data += '</tr>';  	
...
<script>
    ...
    {     
      ...
      var ItemName = $("#itemid option:selected").text();     
        ...
        $.ajax({
            url: "<?php echo admin_url(); ?>PurchaseMaster/export_GetPurchaseReturnReportFilterData",
            method: "POST",
            data: {Partyname,Centertext,ReportTypetext,ItemName,ItemID,Report_type,AccountID, 
                from_date, to_date, CenterID},
            beforeSend: function() {
                // setting a timeout
