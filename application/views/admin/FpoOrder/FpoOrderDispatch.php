...
<div id="wrapper">
	<div class="content">
	    <div class="row" style="display:none;">
				<div class="col-md-12">
					<table id="print_table" style="width: 100%; border-collapse: collapse; table-layout: fixed;" border="1">
						...
						<tbody>
							<tr>
								<td colspan="12"><center><b>Dispatch Order</b></center></td>
							</tr>
							<tr>
								<td colspan="3"><b>PO No :</b> <?php echo $OrderDetails->OrderID; ?></td>
								<td colspan="3"><b>PO Date : </b><?php echo _d(substr($OrderDetails->Transdate,0,10)) ; ?></td>
								<td colspan="3"><b>Disp No :</b> <?php echo $OrderDetails->dispatchID; ?></td>
								<td colspan="3"><b>Disp Date : </b><?php echo _d(substr($OrderDetails->Transdate,0,10)) ; ?></td>
							</tr>
							<tr>
								<td colspan="6"><b>Center Name : </b><?php echo $OrderDetails->details[0]["CenterName"]; ?> </td>
								<td colspan="6"><b>Vendor Name : </b><?php echo $OrderDetails->FPOName ; ?></td>
							</tr>
							<tr>
								<td colspan="6"><b>Item Name : </b><?php echo $OrderDetails->ItemName ; ?> </td>
								<td colspan="3"><b>Vehicle No : </b><?php echo $OrderDetails->details[0]["VehicleNo"] ; ?></td>
								<td colspan="3"><b>E-Way No : </b><?php echo $OrderDetails->ItemName ; ?> </td>
							</tr>
							<tr>
								<td colspan="6"><b>Ack No : </b><?php echo $OrderDetails->FpoRate ; ?></td>
								<td colspan="6"><b>Ack Date : </b><?php echo $OrderDetails->details[0]["VehicleNo"] ; ?></td>
							</tr>
							...
							<tr>
								<td colspan="6" align="left">Farmer Name</td>
								<td colspan="3" align="center">Net Wt</td>
								<td align="center">UOM</td>
								<td colspan="2" align="center">Bag Qty</td>
							</tr>
							<?php
							    $TotalBag = 0;
							    $TotalWeight = 0;
								if(isset($OrderDetails->details)){
									foreach ($OrderDetails->details as $key => $value) {
									    if($value["DispatchQty"] > 0){
									        $TotalBag += $value["DispatchBag"];
									        $TotalWeight += $value["DispatchQty"];
									?>
									<tr style="white-space: nowrap;">
										<td colspan="6" align="left"><?php echo $value["FarmerName"]; ?></td>
										<td colspan="3" align="center"><?php echo $value["DispatchQty"]; ?></td>
										<td align="center"><?php echo "Qtls"; ?></td>
										<td colspan="2" align="center"><?php echo $value["DispatchBag"]; ?></td>
									</tr>    
									<?php
									    }
									}
							...
							<tr class="" style=" white-space: nowrap;">
								<td colspan="10" align="right">Total Weight</td>
								<td align="right"><?php echo number_format($TotalWeight, 2, '.', '');?></td>
							</tr>
							<tr class="" style=" white-space: nowrap;">
								<td colspan="10" align="right">Total Bag </td>
								<td align="right"><?php echo number_format($TotalBag, 2, '.', '');?></td>
							</tr>
        ...
        <div class="panel-body">
            <nav aria-label="breadcrumb" >
				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
					...
					<li class="breadcrumb-item active" aria-current="page"><b>FPO Dispatch Order</b></li>
				</ol>
			</nav>
			<hr class="hr_style">
            ...
            <div class="tab-content">
                ...
                <div class="row">
				    ...
				    <?php
                        ...
                        $new_FPO_DispatchNumbar = get_option('next_DIS_number_for_kirti');
                        $format = get_option('invoice_number_format');
               
						$prefix = "DIS";
						$__number = $new_FPO_DispatchNumbar;
						$prefix = $prefix.'<span id="prefix_year">'.$fy.'</span>';
                        $_Dis_number = str_pad($__number, get_option('number_padding_prefixes'), '0', STR_PAD_LEFT);
                        
                        $edit_orderID = $OrderDetails->dispatchID;
                        $ExistOrderId = substr($edit_orderID, 5);
                        
                        $CenterID = $OrderDetails->details[0]['CenterID'];
                        $Vehicle = $OrderDetails->details[0]['VehicleNo'];
                    ?> 
					    <div class="form-group">
                            <label for="pro_orderid">DIS.No</label>
                            <div class="input-group">
                                <span class="input-group-addon"><?php echo $prefix; ?></span>
                                <input type="text" name="dispatch_id" id="dispatch_id" class="form-control receiptsid" value="<?php echo !empty($ExistOrderId) ? $ExistOrderId : $_Dis_number; ?>" data-isedit="<?php echo $isedit; ?>" data-original-number="<?php echo $data_original_number; ?>" <?php echo ($ExistOrderId) ? 'disabled' : '' ?>>
                                <input type="hidden" name="dispatchno" id="dispatchno" value="<?php echo $edit_orderID; ?>">
                            </div>
                        </div>
                    </div> 
                    <div class="col-md-2">
                    <?php
                        ...
                        $Status = $OrderDetails->details[0]['FpoStatus'];
                        $is_pagedisabled = ($Status == 3);
                    ?>
                        <input type="hidden" name="disorder" id="disorder" value="<?php echo $OrderDetails->OrderID;?>">
                         <input type="hidden" name="ItemID" id="ItemID" class="form-control" value="<?php echo $OrderDetails->ItemID;?>" readonly>
                          <input type="hidden" name="fpoidname" id="fpoidname" class="form-control" value="<?php echo $OrderDetails->FPOID;?>" readonly>
                        <?php
                            $order_date_raw = isset($OrderDetails->details[0]['dispatchdate']) && !empty($OrderDetails->details[0]['dispatchdate']) 
                              ? $OrderDetails->details[0]['dispatchdate'] 
                              : $date;
                              $order_date = explode(' ', _d($order_date_raw))[0];
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="fpono">FPO.No</label>
                            <input type="text" name="fpono" id="fpono" class="form-control" value="<?php echo $OrderDetails->OrderID;?>" readonly>
                        </div>
                    </div>
                    
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="fpolist">FPO Name</label>
                            <input type="text" name="fpolist" id="fpolist" class="form-control" value="<?php echo $OrderDetails->FPOName;?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="ItemName" id="ItemName" class="form-control" value="<?php echo $OrderDetails->ItemName;?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="CenterID" id="CenterID" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="Non Selected" 
                                 <?php echo ($is_pagedisabled) ? 'disabled' : ''; ?>>
                                <option value=""></option>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="vehicle_no" id="vehicle_no" class="form-control" value="<?php echo $Vehicle;?>" <?php echo ($is_pagedisabled) ? 'readonly' : ''; ?>>
                        </div>
                    </div>
                    
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="vehicle_no">E-Way Bill No</label>
                            <input type="text" name="e_way_bill_no" id="e_way_bill_no" class="form-control" value="<?php echo "";?>" <?php echo ($is_pagedisabled) ? 'readonly' : ''; ?>>
                        </div>
                    </div>
        ...
        <p class="bold p_style"><?php echo _l('FPO Dispatch Detail'); ?></p>
        <hr class="hr_style"/>
        ...
        <div class="row">
            <div class="col-md-12 mtop15">
                ...
                ?>
                    <button type="button"  class="mleft10 pull-right btn btn-warning EWayBill"><i class="fa fa-spinner fa-spin EWayBillSpinner" style="display:none" ></i> Generate E-Way Bill </button>
                    
                <?php
                    }
                    // Create mode
                    if (empty($edit_orderID) && has_permission_new('FpoOrder_Dispatch', '', 'create')) {
                    ?>
                    ...
                    // Edit mode
                    if (!empty($edit_orderID) && has_permission_new('FpoOrder_Dispatch', '', 'edit')) {
                    ?>
                       <button type="button"  class="btn-tr save_detail btn btn-info mleft10 estimate-form-submit transaction-submit">
                        <?php echo _l('update'); ?></button>
                    <?php
                    }
                    if(isset($OrderDetails)){
                ?>
                        &nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" id="printbtn" onclick="printPage();"><i class="fa fa-print"></i> Print</button>
                <?php
                    }
                    ?>
                        ...
                        <table class="tree table table-striped table-bordered table_purchase_report" id="table_purchase_report" width="100%">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="width:15% text-align:left;">Fpo List</th>
                                    <th style="width:7% text-align:left;">Rate</th>
                                    <th style="width:7% text-align:left;">Vehicle No.</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script>
    ...
    $('.EWayBill').on('click', function() {
        ...
        var url = "<?php echo base_url(); ?>admin/FpoOrder/generateEwayBill";
        jQuery.ajax({
            type: 'POST',
            url:url,
            ...
            success: function(data) {
				if (data.Status === true && data.ErrorMsg == '') {
					alert_float('success', 'E-Way Bill generated Successfully');
					//window.location.reload();
				}else if (data.Status == true && data.ErrorMsg != '') {
					var msg = data.SuccessMsg+data.ErrorMsg;
					if(confirm(msg)){
						//window.location.reload();
				    }
				} else {
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        for(var count = 0; count < data.length; count++)
        {
            ...
            html += '<td style="text-align:right;">'+data[count].company+'</td>';
            html += '<td style="text-align:left;">'+data[count].FpoRate +'</td>';
            html += '<td style="text-align:left;">'+data[count].VehicleNo +'</td>';
            html += '</tr>';
        }
...
<?php require 'Fpo_Dis_order_js.php';?>
