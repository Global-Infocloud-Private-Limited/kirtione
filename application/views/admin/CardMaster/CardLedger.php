        ...
        <div class="panel-body">
            <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Account Ledger</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
            ...
            <div class="col-md-12">
              ...
              <?php //echo form_open(admin_url('accounting/view_report2'),array('id'=>'filter-form')); ?>
                ...
                <div class="col-md-1">
                  ...
                  <?php if (has_permission_new('CardLedger', '', 'view')) {
                ?>
                ...
                <div class="col-md-4">
                  <div class="btn-group mtop25">
                    <?php if (has_permission_new('CardLedger', '', 'export')) {
                    ?>
                    <a class="btn btn-default buttons-excel buttons-html5" tabindex="0" style="margin-right: 10px;" aria-controls="ledger_report" href="#" id="caexcel"><span>Export to excel</span></a>
                    <?php } ?>
                    
                    <?php if (has_permission_new('CardLedger', '', 'print')) {
                    ?>
                    <a class="btn btn-default" href="javascript:void(0);" onclick="printPage();" style="margin-right: 10px;">Print</a>
                    <?php } ?>
              ...
              <table class="tree table table-striped table-bordered ledger_report tableFixHead" id="ledger_report">
                  <thead>
                    <tr class="only_print" style="display:none;" align="right">
                        <th colspan="7" style="text-align:center;" align="right"><b><?php echo $company_detail->company_name; ?></b></th>
                    </tr>
                    <tr class="only_print" style="display:none;" align="right">
                        <th colspan="7" style="text-align:center;" align="right"><b><?php echo $company_detail->address; ?></b></th>
                    </tr>
...
<script>
    ...
    function Show_ladger()
    {
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>CardMaster/GetLedgerData",
            dataType:"JSON",
            method:"POST",
            data:{from_date:from_date, to_date:to_date, accounting_method:accounting_method, plant_id:plant_id},
                beforeSend: function () {
    ...
    function printPage()
{
    ...
    var tableData = '<table  border="1" cellpadding="0" cellspacing="0" width="100%" class="tree table table-striped table-bordered" style="font-size:12px;">'+document.getElementsByTagName('table')[0].innerHTML+'</table>';
        var heading_data = '<table  border="1" cellpadding="0" cellspacing="0" width="100%" class="tree table table-striped table-bordered" style="font-size:12px;"><tbody><tr><td style="text-align:center;" colspan="7"><?php echo $company_detail->company_name; ?></td></tr><tr><td style="text-align:center;" colspan="7"><?php echo $company_detail->address; ?></td></tr>';
         heading_data += '<tr>';
