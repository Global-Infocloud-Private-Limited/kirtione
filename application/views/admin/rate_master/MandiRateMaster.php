                    ...
                    <div class="col-md-12 text-centerr"  >
    					<nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Mandi Purchase Rate Master</b></li>
                                ...
                                <tr>
                                    ...
                                    <?php
                                        foreach($center as $key =>$value){
                                            $ColSpan = 0;
                                            $CompetitorIDs = $value["MandiIDs"];
                                            $Competitor_array = explode(',', $CompetitorIDs);
                                            
                                            foreach($Mandi as $Ckey =>$Cvalue){
                                                    ...
                                                    foreach($Mandi as $Ckey1 =>$Cvalue1){
                                                        if(in_array($Cvalue1["CompetitorID"], $Competitor_array1)){
                                                            if(in_array($ItemValue1["ItemID"], $Item_array)){
                                                                ...
                                                                ?>
                                                                    <td style="background-color: #ada6a0;"></td>
                                                                <?php
                                                            }
                                                        }
                                                    }
...
<script>
    function myFunction(new_rate,id){
        ...
        if(parseFloat(old_rate) != parseFloat(new_rate) && new_rate != ""){
            $.ajax({
                url:"<?php echo admin_url(); ?>rate_master/UpdateMandiRateByAjax",
                method:"POST",
