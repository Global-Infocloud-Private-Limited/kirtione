        ...
        <div class="panel_s">
                    ...
                    <div class="col-md-12 text-centerr"  >
    					<nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Farmer Rate Master</b></li>
            ...
            <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <?php if(has_permission_new('DailyFarmerRate','','edit')){ ?>
				...
				<div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 >Update Rates for Kirti Purchase (Farmer)</h4>
                                <hr>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group"><small class="req text-danger">* </small> 
                						<label for="CenterSelect" class="control-label">Center</label>
                						<select class="selectpicker" name="CenterSelect" data-live-search="true" id="CenterSelect" data-width="100%">
                						    <option value="">Non Selected</option>
                            ...
                            <div class="col-md-6" style="border-left: 1px solid;">
                                <h4 >Update Trading Status for Kirti Purchase(Farmer)</h4>
                                <hr>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group"><small class="req text-danger">* </small> 
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group"><small class="req text-danger">* </small>
                						<label for="Center_on_of" class="control-label">Select Center </label> 
                						<select class="selectpicker" name="Center_on_of" data-live-search="true" tabindex="-98" multiple = "1" data-actions-box = "1" id="Center_on_of" data-width="100%">
                						    <?php
                						        foreach($center as $value){
                						            ?>
                						               <option value="<?php echo $value['CenterID'];?>"><?php echo strtoupper($value['CenterName']);?></option>
                						            <?php
                						        }
                						    ?>
                						</select>
                                                    ...
                                                    if($match >0){
                                                            ...
                                                            foreach($Rate as $rateKey =>$RateValue){
                                                                if($RateValue["ItemID"] == $ItemValue1["ItemID"] && $RateValue["CenterID"] == $value1["CenterID"]){
                                                                    $rate = $RateValue["Rate"];
                                                                    $TradeOnOff = $RateValue["TradeOnOffFarmer"];
                                                                }
                                                            }
                                                            if($TradeOnOff == 'Y'){
...
$(document).ready(function(){
    ...
    $('#Commodity').on('change', function() {
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                ...
                //$("#CenterSelect").append(new Option("None selected", ""));
    ...
    $('#Commodity_on_off').on('change', function() {
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                ...
                //$("#Center_on_of").append(new Option("None selected", ""));
                for (var i = 0; i < data.length; i++) {
    ...
    $('.TradingupdateBtn').click(function(){
        ...
        if(Commoditys == ""){
            ...
            $.ajax({
                url:"<?php echo admin_url(); ?>rate_master/UpdateTradingStatus",
                method:"POST",
                data:{Commoditys:Commoditys,CenterIDs:CenterIDs,trading_status:trading_status,Type:Type}, 
                dataType:'json',
                success: function(data){
                    if(data == true){
    ...
    $('.updateBtn').click(function(){
        ...
        if(Commodity == ""){
            ...
            $.ajax({
                url:"<?php echo admin_url(); ?>rate_master/UpdateFarmerRateByForm",
                method:"POST",
...
<script>
    function myFunction(new_rate,id){
        ...
        if(parseFloat(old_rate) != parseFloat(new_rate) && new_rate != ""){
            $.ajax({
                url:"<?php echo admin_url(); ?>rate_master/UpdateFarmerRate",
                method:"POST",
