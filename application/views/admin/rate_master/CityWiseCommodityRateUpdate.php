                ...
                <div class="panel_s">
                    <div class="panel-body">
                            ...
                            <div class="col-md-12 text-centerr">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><b>Kirti Purchase Trader Rate City Wise
                                        </b></li>
                                    </ol>
                                </nav>
                        ...
                        <div class="row mtop15">
                            <div class="col-md-12">
                                <?php if (has_permission_new('CityWiseCommodityRate', '', 'edit')) { ?>
                                ...
                                <?php } ?>
                                <?php if (has_permission_new('CityWiseCommodityRate', '', 'print')) { ?>
...
$(document).ready(function() {
    ...
    $('#Commodity').on('change', function() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo admin_url(); ?>rate_master/GetItemWiseCity",
            data: { ItemID: ItemID },
            dataType: 'json',
    ...
    $('#updateCityRatesBtn').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo admin_url(); ?>rate_master/UpdateCityWiseRate",
            method: 'POST',
            data: {
                Commodity: commodity,
...
function printCityRateReport() {
    ...
    var heading = '<table width="100%" style="margin-bottom:10px;"><tr><td style="text-align:center;font-weight:bold;font-size:14px;">Kirti Purchase Trader Rate City Wise</td></tr>';
