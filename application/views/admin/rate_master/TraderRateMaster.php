        ...
        <div class="panel_s">
                    ...
                    <div class="col-md-12 text-centerr"  >
    					<nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Trader Kirti Purchase Rate Master</b></li>
            ...
            <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <?php if(has_permission_new('DailyTraderRate','','edit')){ ?>
            ...
            <hr>
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 >Update Rates for Kirti Purchase (Trader)</h4>
                                <hr>
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="col-md-6" style="border-left: 1px solid;">
                                <h4 >Update Trading Status for Kirti Purchase(Trader)</h4>
                                <hr>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group"><small class="req text-danger">* </small> 
                                                    ...
                                                    if($match >0){
                                                            ...
                                                            foreach($Rate as $rateKey =>$RateValue){
                                                                if($RateValue["ItemID"] == $ItemValue1["ItemID"] && $RateValue["CenterID"] == $value1["CenterID"]){
                                                                    $rate = $RateValue["Rate"];
                                                                    $TradeOnOff = $RateValue["TradeOnOff"];
                                                                }
                                                            }
                                                            if($TradeOnOff == 'Y'){
...
$(document).ready(function(){
    ...
    $('.updateBtn').click(function(){
        ...
        if(Commodity == ""){
            ...
            $.ajax({
                url:"<?php echo admin_url(); ?>rate_master/UpdateRateByForm",
                method:"POST",
...
<script>
    function myFunction(new_rate,id){
        ...
        if(parseFloat(old_rate) != parseFloat(new_rate) && new_rate != ""){
            $.ajax({
                url:"<?php echo admin_url(); ?>rate_master/UpdateRate",
                method:"POST",
