					...
					<div class="panel-body">
						<nav aria-label="breadcrumb" >
							<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
								...
								<li class="breadcrumb-item active" aria-current="page"><b>Stock Position</b></li>
							</ol>
						</nav>
						<hr class="hr_style">
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="custom_button">
											...
											<?php if (has_permission_new('K1StockPosition', '', 'export')) {
											?>
											...
											<?php if (has_permission_new('K1StockPosition', '', 'print')) {
											?>
	...
	$(document).ready(function(){
		...
		$('#search_data').on('click',function(){
			...
			if(CenterID == "" || CenterID== null){
				...
				}else if(ItemGroup == "" || ItemGroup== null){
				alert('please select item group');
		}else{
				$.ajax({
					url:"<?php echo admin_url(); ?>K1InventoryMaster/GetStockReport",
					dataType:"JSON",
					method:"POST",
					cache: false,
					data:{from_date:from_date,to_date:to_date,ItemGroup:ItemGroup,
					CenterID:CenterID,GodownID:GodownID,PartyID:PartyID},
					beforeSend: function () {
		...
		$("#caexcel").click(function(){
			...
			if(ItemGroup == "" || ItemGroup== null){
				...
				$.ajax({
					url:"<?php echo admin_url(); ?>K1InventoryMaster/export_stock_report",
					method:"POST",
					data:{from_date:from_date,to_date:to_date,ItemGroup:ItemGroup,
					CenterID:CenterID,GodownID:GodownID,PartyID:PartyID},
					beforeSend: function () {
...
<style>
	...
	.stock_position thead { position: sticky; top: 0; z-index: 1; }
	/*.stock_position tbody th { position: sticky; left: 0; z-index: 1;}*/
