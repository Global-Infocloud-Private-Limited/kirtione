										...
										<div class="table-AccountSubgroup tableFixHead2">
											<table class="tree table table-striped table-bordered table-AccountSubgroup tableFixHead2" id="table_AccountSubgroup" width="100%">
												<thead>
													...
													<tr>
														<th id="sl">SubAccountGroupID2 <span class="up_starting">  &#8595;</span><span class="up" style="display:none;"> &#8593;</span><span class="down" style="display:none;"> &#8595;</span></th>
												...
												<tbody>
													<?php
														...
														?>
														<tr class="get_AccountID" data-id="<?php echo $value["SubActGroupID2"]; ?>">
				...
				$.ajax({
					...
					success:function(data){
						if(empty(data)){
							...
							$('#subgroup_code').val(data.SubActGroupID2);
