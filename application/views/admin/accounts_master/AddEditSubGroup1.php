          ...
          <div class="panel-body">
              ...
              <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Account SubGroups1</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
                <div class="row">
                    ...
                    <input type="hidden" name="OldAccountSubGroupID3" id="OldAccountSubGroupID3" value="<?php echo str_pad($NextAccountGroupID1, 6, '0', STR_PAD_RIGHT);?>">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="subgroup_code">AccountSubGroupId1</label>
                            <input type="text" name="subgroup_code" id="subgroup_code" class="form-control" value="<?php echo str_pad($NextAccountGroupID1, 6, '0', STR_PAD_RIGHT);?>" onkeypress="return isNumber(event)">
                                        
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        <label for="subgroup_name">AccountSubGroupId1 Name</label>
                ...
                <div class="row"> 
                    <div class="col-md-12">
                        <?php if (has_permission_new('SubGroup1', '', 'create')) {
                        ?>
                        ...
                        <?php if (has_permission_new('SubGroup1', '', 'edit')) {
                        ?>
