	...
	$(function(){
		$('#search_data').on('click',function(){
			...
			if (dates.trim()!=''){
				...
				initDataTable('.table-gatepass', admin_url+'KirtiOneOrder/Challangatepass_list', undefined, undefined, CustomersServerParams,<?php echo hooks()->apply_filters('projects_table_default_order', json_encode([0, 'desc'])); ?>);
				}else{
