                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            ...
                            <table >
                                ...
                                <tr>
                                    <td></td>
                                    <td>Reciept from Debitors</td>
                                    <td><?php echo $ledger_detail->AMT; ?></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>&nbsp; &nbsp;&nbsp; Less cash purchases</td>
                                    <td>0</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>&nbsp; &nbsp;&nbsp; Paid to creditors and other</td>
                                    <td><?php echo $ledger_details->AMTS; ?></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>&nbsp; &nbsp;&nbsp;Cash generated from Operating Activities</td>
                                    <td><?php echo ($ledger_detail->AMT)-($ledger_details->AMTS); ?></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>&nbsp; &nbsp;&nbsp;Less Income Tax Paid</td>
                                    <td><?php echo ( $taxc_details - $taxd_details ); ?></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    <td></td>
                                    <td>&nbsp; &nbsp;&nbsp;Add/Less Extraodinary Items</td>
                                    <td>0</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><?php echo (($ledger_details->AMTS)-($ledger_detail->AMT)) + ( $taxc_details - $taxd_details ); ?></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
