                    ...
                    <div class="panel-body">
                        <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Rate Report</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
                        <div class="row ">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker display-block" data-width="100%" name="rate" id="rate"
                                        class="form-control required">
                                        <option value="Not Selected">Not Selected</option>
                                        <option value="Kirti purchase farmer">Kirti purchase (Farmer)</option>
                                        <option value="Kirti purchase trader">Kirti purchase (Trader)</option>
                                        <option value="Competitor rate">Kirti Competitor Rate</option>
                                        <option value="Kirti sales">Kirti Sales</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group" app-field-wrapper="center">
                                    ...
                                    <select multiple name="center" id="center" class="selectpicker form-control"
                                        data-width="100%" data-none-selected-text="Non Selected"  data-actions-box = "1"
                                        data-live-search="true">
                                        <option value="">Non Selected</option>
                                        <!-- <button type="button" class="btn btn-primary" id="select-all">Select All</button>
                                        <button type="button" class="btn btn-danger" id="deselect-all">Deselect All</button> -->
                                        <?php
                            ...
                            <button class="btn btn-info pull-left mleft5 search_data" style="margin-top: 19px;"
                                id="search_data">Report
                            </button>

                            <div class="col-md-5">
                                <?php if (has_permission_new('rate_report', '', 'export')) {
                                ?>
                                ...
                                <?php if (has_permission_new('rate_report', '', 'print')) {
                                ?>
    ...
    $('#search_data').on('click', function () {
        ...
        if (rate == "Not Selected") {
            ...
            $.ajax({
                ...
                dataType: "json",
                method: "POST",
                data: { from_date: from_date, rate: rate, center: center, to_date: to_date, },
                beforeSend: function () {
                    $('.tableFixHead2').html();
