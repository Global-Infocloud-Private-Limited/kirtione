                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="custom_button">
                                ...
                                <?php if (has_permission_new('stock_position', '', 'export')) {
                                ?>
                                ...
                                <?php if (has_permission_new('stock_position', '', 'print')) {
                                ?>
...
$('#CenterID').on('change', function() {
 ...
 $('#search_data').on('click',function(){
	    ...
	    if(ItemGroup == "" || ItemGroup== null){
          ...
          CenterID:CenterID,GodownID:GodownID,PartyID:PartyID,Service_type:Service_type},
          beforeSend: function () {
