...
<script>
    $('#ItemSubCat').on('change', function () {
        ...
        if (ItemSubCat) {
            $.ajax({
                url: "<?php echo admin_url(); ?>ItemMaster/GetItemListByCategory",
                type: 'POST',
                data: { ItemSubCat: ItemSubCat },
    ...
    $('#ItemID').on('change', function () {
        ...
        if (ItemID) {
            $.ajax({
                url: "<?php echo admin_url(); ?>ItemMaster/GetProductDetailsbyProductID",
                type: 'POST',
                data: { ItemID: ItemID },
...
//=============================== Search rate List =================================
    function GetRateList(){
        ...
        $.ajax({
            url: "<?php echo admin_url(); ?>ItemMaster/GetAllItemRateList", 
            type: 'POST', 
            data: {ItemSubCat:ItemSubCat,ItemID:ItemID,CenterID:CenterID}, 
            //dataType: "JSON",
...
//=============================== Add New Rate =================================
    $('.saveBtn').on('click',function() 
    {
        ...
        if (ItemID == "") {
            ...
            $.ajax({
                url: "<?php echo admin_url(); ?>ItemMaster/AddNewItemWiseRate", 
                type: 'POST', 
                data: {ItemID:ItemID,CenterID:CenterID,new_salerate:new_salerate,new_basicrate:new_basicrate,new_discAmt:new_discAmt,taxrate:taxrate}, 
                dataType: "JSON",
                success: function(response) {
                    if (response.success) 
                    {     
