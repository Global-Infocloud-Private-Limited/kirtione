                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a data-toggle="tab" href="#EXEMP" class="EXEMP" >EXEMP</a></li>
                            <li><a data-toggle="tab" href="#HSN" class="HSN" >HSN</a></li>
                            <li><a data-toggle="tab" href="#DOCS" class="DOCS" >DOCS</a></li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="" id="B2B" >
                        ...
                        <div class="" id="EXEMP" >
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="fixed_header1" id="fixed_header1">
                                    <table class="table table-striped table-bordered EXEMP_tbl" id="EXEMP_tbl" width="100%">
                                        <thead>
                                            <tr>
                                                <th>SrNo</th>
                                                <th>Description</th>
                        ...
                        <div class="" id="DOCS" >
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="fixed_header1" id="fixed_header1">
                                    <table class="table table-striped table-bordered DOCS_tbl" id="DOCS_tbl" width="100%">
                                        <thead>
                                            <tr>
                                                <th>SrNo</th>
...
$(document).ready(function(){
    $('#search_data').on('click',function(){
        ...
        $.ajax({
            url:"<?php echo admin_url(); ?>K1E_Filling/K1GSTR1Reports",
            dataType:"JSON",
            method:"POST",
            ...
            success:function(data){
                $('#B2B_tbltbody').html(data.B2BHTML);
 ...
 var to_date = $("#to_date").val();
    ...
    $.ajax({
        url:"<?php echo admin_url(); ?>K1E_Filling/GSTR1ReportsExport",
        method:"POST",
        data:{from_date:from_date,to_date:to_date},
        beforeSend: function () {
