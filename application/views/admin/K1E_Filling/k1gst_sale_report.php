          ...
          <div class="panel-body">
            <nav aria-label="breadcrumb" >
				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
					...
					<li class="breadcrumb-item active text-capitalize"><b>k1 E-Filling </b></li>
					<li class="breadcrumb-item active" aria-current="page"><b>k1 GST Sales Report</b></li>
				</ol>
			</nav>
			<hr class="hr_style">
              <div class="_buttons">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="estimate">Bill Type</label>
                            <select name="bill_type" id="bill_type" class="form-control selectpicker">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="estimate">GST Structure</label>
                            <select name="gst_type" id="gst_type" class="form-control selectpicker">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                           ...
                           <select name="bill_wise_type" id="bill_wise_type" class="form-control selectpicker">
                ...
                <div class="row">
                    ...
                    <div class="custom_button" style="padding-top: 20px;">
                        <?php if (has_permission_new('k1GSTR_sales', '', 'view')) {
                        ?>
                    ...
                    <div class="custom_button">
                        <?php if (has_permission_new('k1GSTR_sales', '', 'print')) {
                        ?>
                    ...
                    <div class="custom_button">
                        &nbsp;&nbsp;
                        <?php if (has_permission_new('k1GSTR_sales', '', 'export')) {
                                ?>
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function()
    {
        $('#search_data').on('click',function()
        {
    	    ...
    	    $.ajax({ 
              url:"<?php echo admin_url(); ?>K1E_Filling/load_table",
              dataType:"JSON",
              method:"POST",
              cache: false,
              data:{from_date:from_date,account_full_name:account_full_name, to_date:to_date,accountId:accountId,bill_type:bill_type,bill_wise_type:bill_wise_type,gst_type:gst_type,act_name:act_name},
              beforeSend: function () {
    ...
    $("#caexcel").click(function(){
        ...
        $.ajax({
            url:"<?php echo admin_url(); ?>K1E_Filling/export_gst_sale_report",
            method:"POST",
