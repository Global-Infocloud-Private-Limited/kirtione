          ...
          <div class="panel-body">
                ...
                <div class="row">
                   ...
                   <div class="col-md-2">
						...
						<input type="text" id="TDSCode" name="TDSCode" class="form-control numbers-only2" value="">
								...
								id="table_AccountHead_List" width="100%">
                                    <thead>
                                        <tr style="display:none;">
                                            <td colspan="9" ><h5 style="text-align:center;"><span style="font-size:15px;font-weight:700;"><?php echo $company_detail->company_name; ?>
                                    ...
                                    ?>
									<tr class="get_AccountID" data-id="<?php echo $value["TDSCode"]; ?>">
...
<script>
function allowDigitsAndSpecialChars(element) {
    $(element).keypress(function (e) {
        ...
        var allowedSpecialChars = [33, 35, 36, 37, 38, 42, 43, 45, 47, 58, 59, 60, 61, 62, 63, 64, 91, 92, 93, 94, 95, 123, 124, 125, 126];
        if (allowedSpecialChars.includes(e.which)) {
            return true;
        }
        return false;
    });
...
$(document).ready(function() {
    allowDigitsAndSpecialChars(".numbers-only2");
});
</script>
<style>
#tds_code {
