          ...
          <div class="panel-body">
              <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>GST Sales Report</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
              <div class="_buttons">
                ...
                ?>   
                    ...
                    <div class="custom_button">
                        <?php if (has_permission_new('GSTR_sales', '', 'print')) {
                                ?>
                    ...
                    <div class="custom_button">
                        &nbsp;&nbsp;
                        <?php if (has_permission_new('GSTR_sales', '', 'export')) {
                                ?>
