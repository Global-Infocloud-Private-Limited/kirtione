...
$(document).ready(function(){  
  ...
  function load_data(){
    ...
    $.ajax({
      url:"<?php echo admin_url(); ?>SaleReturn/GetSRReportFilterData",
      method:"POST",
...
<script type="text/javascript">
    function printPage()
    {
        ...
        heading_data += '<tr>';
        heading_data += '<td style="text-align:center;"colspan="3">Sales Return Report : From : ' + from_date + ', To : ' + to_date + ', Center Name : ' + center + ', Report Type : ' + reporttype + ', Party Name : ' + party + '</td>';
        heading_data += '</tr>';  	
...
<script>
    ...
    {     
      ...
      var ItemName = $("#itemid option:selected").text();     
        ...
        $.ajax({
            url: "<?php echo admin_url(); ?>SaleReturn/export_GetSRReportFilterData",
            method: "POST",
