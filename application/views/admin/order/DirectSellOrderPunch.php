                ...
                <div class="panel-body">
    		        ...
    		        <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <?php echo render_date_input('credit_note_date','Posting Date',$value,$attr); ?>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group" app-field-wrapper="PaymentCycle">
                                <label for="PaymentCycle" class="control-label">Payment Terms</label>
                                <select name="PaymentCycle" id="PaymentCycle" class="selectpicker form-control" data-none-selected-text="Non Selected" data-live-search="true">
                                <?php 
                        ...
                        <!--<div class="col-md-2" >
                            <label for="act_name">Party GST / Aadhaar</label>
                            <input type="text" name="gst_no" id="gst_no" readonly class="form-control" value="<?php echo $GST_Aadhar; ?>">
                        </div>
                        <div class="col-md-2" >
                            <label for="state">State Name</label>
                            <input type="text" name="state" id="state" readonly class="form-control" value="<?php echo $state; ?>">
                            <input type="hidden" name="state_short_code"  id="state_short_code"  value="<?php echo $state_Short_name; ?>">
                        </div>
                        <div class="col-md-2" >
                            <label for="act_name">Closing Balance</label>
                            <input type="text" name="gst_no" id="gst_no" readonly class="form-control" value="<?php echo $GST_Aadhar; ?>">
                        </div>-->
                    </div> 
                        ...
                        <div class="col-md-12">
                            <div class="table_cd_report">
                                <table class="tree table table-striped table-bordered table_cd_report" id="table_cd_report" width="100%">
                                    <thead>
                                        <tr>
                                            <th style="width:7%">ItemID</th>
                                            <th style="width:20%">Item Name</th>
                                            <th style="width:7%">HSN</th>
                                            <th style="width:5%">Unit</th>
                                            <th style="width:5%">Rate(MT)</th>
                                            <th style="width:5%">Quantity(MT)</th>
                                    ...
                                    <tbody id="tbody">
                                        <tr id='R1'>
                                            <td><input type="text" name="item_code" id="item_code" style="width: 100%;border-radius: 2px;height: 30px;"></td>
                                            <td><span id="item_name"></span><input type="hidden" name="item_name_val" id="item_name_val" value=""></td>
                                            <td><span id="hsn"></span><input type="hidden" name="hsn_val" id="hsn_val" value=""></td>
                                            <td><span id="unit"></span><input type="hidden" name="unit_val" id="unit_val" value=""></td>
                                            <td><span id="rate"></span><input type="text" name="rate_val" id="rate_val" value="" style="height: 30px;width: 100%;"></td>
                                            <td><span id="qty"></span><input type="text" name="qty_val" id="qty_val" value="" style="height: 30px;width: 100%;" /></td>
                                            <td><span id="sale_amount"></span><input type="hidden" name="sale_amount_val" id="sale_amount_val" value=""></td>
                                            <td><span id="gstper"></span><input type="hidden" name="gstper_val" id="gstper_val" value=""></td>
                                            <td><span id="gstamt"></span><input type="hidden" name="gst_amt_val" id="gst_amt_val" value=""></td>
                                            <td><span id="amount"></span><input type="hidden" name="total_amt_val" id="total_amt_val" value=""></td>
                                            <td><button type="button" name="add" id="add" class="btn btn-xs btn-success" value="add"><i class="fa fa-plus " style="font-size:16px;"></i></button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        </div>
                        <div class="col-md-8" style="margin-top:5%;text-align:right;">
                            <?php if(has_permission_new('cd_notes','','create')){ ?>
                            ...
                            if(has_permission_new('cd_notes','','edit')){ ?>
                                <button type="submit" class="btn btn-info" onclick="this.form.submit();this.disabled = true;"><?php echo 'Update'; ?></button>
                            <?php } } ?>
                        </div>
                        <div class="col-md-4">
...
<script>
    ...
    {
        $.ajax({
            url: "<?=base_url()?>admin/Order/GetSaleItemCenterWiseStaffWise",
            type: 'post',
            dataType: "json",
            data: {
              CenterID: CenterID,
