        ...
        <div class="panel-body">
            <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Daily Trade Finance Trades</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
		    ...
		    <div class="_buttons">
               ...
               <div class="col-md-7">
                    <h5 style="font-size:18px;font-weight:bold;margin:15px 0px 0px 0px;">Daily Trade Finance Trades</h5>
                    </div>
                    
                <div class="col-md-1">
                    <?php if (has_permission_new('Trade_Finance_Booking', '', 'export')) {
                    ?>
                    ...
                    <?php if (has_permission_new('Trade_Finance_Booking', '', 'print')) {
                    ?>
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('#Modify').click(function(){
                    ...
                    /*if(modal_quantity >= old_quantity){
...
<script>
    ...
    function fetchEnquiries() {
        ...
        xhr.open('GET', '<?php echo admin_url(); ?>order/Get_trade_finance_request', true);
...
$(document).ready(function(){
    ...
    function GettableData(from_date,to_date,account_type,center,IsApprove){
        $.ajax({
            url:"<?php echo admin_url(); ?>order/Get_anamat_request_by_show_button",
            dataType:"json",
            method:"POST",
...
<script type="text/javascript">
    function printPage()
    {
        ...
        heading_data += '<tr>';
        heading_data += '<td style="text-align:center;"colspan="3">Anamat Request List</td>';
        heading_data += '</tr>';
        heading_data += '<tr>';
...
$("#caexcel").click(function(){
    ...
    var IsApprove = $("#IsApprove :selected").val();
    $.ajax({
        url:"<?php echo admin_url(); ?>order/export_tradeFinance",
        method:"POST",
        data:{from_date:from_date, to_date:to_date, account_type:account_type,center:center,IsApprove:IsApprove},
        success:function(data){
