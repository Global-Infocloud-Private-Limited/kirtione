                ...
                <div class="panel-body">
                        ...
                        <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Direct Sales Invoice</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
          ...
          <div class="col-md-12 mtop15">
             <div class="panel-body bottom-transaction">
                ...
                <div class="btn-bottom-toolbar text-right" style="width: 100%;">
                  ...
                  <?php if (has_permission_new('orders', '', 'create')){
                      ?>
...
<?php require 'DirectSellOrderPunch_js.php';?>