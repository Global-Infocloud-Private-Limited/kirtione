        ...
        <div class="panel-body">
            <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Daily Anamat Trades</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
		    <div class="_buttons">
               ...
               <div class="col-md-7">
                    <h5 style="font-size:18px;font-weight:bold;margin:15px 0px 0px 0px;">Daily Anamat Trades</h5>
                    </div>
                    
                <div class="col-md-1">
                    <?php if (has_permission_new('Anamat_Booking', '', 'export')) {
                    ?>
                    ...
                    <?php if (has_permission_new('Anamat_Booking', '', 'print')) {
                    ?>
...
<script>
    ...
    function fetchEnquiries() {
        ...
        xhr.open('GET', '<?php echo admin_url(); ?>order/Get_anamat_request', true);
...
$("#caexcel").click(function(){
    ...
    var IsApprove = $("#IsApprove :selected").val();
    $.ajax({
        url:"<?php echo admin_url(); ?>order/export_anamattrader",
        method:"POST",
        data:{from_date:from_date, to_date:to_date, account_type:account_type,center:center,IsApprove:IsApprove},
        success:function(data){
