          ...
          <div class="panel-body">
                ...
                <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Item Group</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <?php if (has_permission_new('itemssubgrp', '', 'edit')) {
                        ?>
...
<script>
            ...
            if(ItemGroupID == ''){
                ...
                success:function(data){
                    ...
                    if(data == null){
                       ...
                       if(data.item_image != '' || data.item_image != 'NA'){
                           img_url = '<?php echo base_url();?>'+'uploads/ItemGroupImages/'+data.item_image;
    ...
    // Save New MainItemGroup
        $('.saveBtn').on('click',function(){ 
            ...
            var project_image = $('#item_image')[0].files[0];
            var formData = new FormData();
            formData.append('ItemGroupID', ItemGroupID);
            formData.append('ItemGroupName', ItemGroupName);
            formData.append('MainItemGroupName', MainItemGroupName);
            formData.append('item_image', project_image);
            $.ajax({
    ...
    // Update Exiting Item
        $('.updateBtn').on('click',function(){ 
            ...
            formData.append('ItemGroupID', ItemGroupID);
            formData.append('ItemGroupName', ItemGroupName);
            formData.append('MainItemGroup', MainItemGroup);
            formData.append('item_image', project_image);
