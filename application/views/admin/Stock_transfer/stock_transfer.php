              ...
              <nav aria-label="breadcrumb" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        $new_TRNSNumber = get_option('next_stock_trf_number_for_kirti');
                            ...
                            <table class="table table-striped table-bordered ItemTable" id="ItemTable" width="100%">
                                ...
                                <tbody id="tbody">
                                    <tr class="accounts" id="row">
                                        ...
                                        <td style="padding:1px 5px !important;text-align: center;"><span id="stock"></span><input type="hidden" name="stock_val" id="stock_val" value=""></td>
                        ...
                        <div class="modal-body" style="padding:0px 5px !important">
                            ...
                            <div class="table-Item_List tableFixHead2">
                                <table class="tree table table-striped table-bordered table-Item_List tableFixHead2" id="table_Item_List" width="100%">
                                    ...
                                    ?>
                                        <tr class="get_ItemID" data-id="<?php echo $value["ItemID"]; ?>">
...
$(document).ready(function(){
   ...
   // blur from ItemID 
                ...
                if(TrnsTo == "" || TrnsTo == null){
                    ...
                    if(PRDR_ItemID_list_array.includes(ItemID.toUpperCase())){
                      alert("item already added");
                        ...
                        $.ajax({
                          url:"<?php echo admin_url(); ?>Stock_transfer/GetItemDetails",
                          dataType:"JSON",
                          method:"POST",
                          cache: false,
                          ...
                          success:function(data){
                            ...
                            if(empty(data)){
                                ...
                                $('#ItemName_val').val(data.ItemName);
                                ...
                                $('#stock_val').val(data.OQty);
                                $('#stock').html(data.OQty);
                                $('#qty_val').focus();
                            }
                          }
                        });
        ...
        if(TrnsFrom == "" || TrnsFrom == null){
            ...
            if(TrnsTo == "" || TrnsTo == null){
                ...
                for (i=1;i<ItemCount;i++) {
                    ...
                    var id3= 'qty_val'+i;
                    var qty = document.getElementById(id3).value;
                    var ii = i - 1;
                ...
                $.ajax({
                url:"<?php echo admin_url(); ?>Stock_transfer/SaveTransfer",
                dataType:"JSON",
                method:"POST",
    ...
    $('#updateBtn').on('click',function(){ 
        ...
        if(TrnsFrom == "" || TrnsFrom == null){
            ...
            if(TrnsTo == "" || TrnsTo == null){
                ...
                $.ajax({
                url:"<?php echo admin_url(); ?>Stock_transfer/UpdateTransfer",
                dataType:"JSON",
                method:"POST",
    ...
    $('#TransID').on('blur',function(){
        ...
        $('#ItemID').focus();
            $.ajax({
                  url:"<?php echo admin_url(); ?>Stock_transfer/GetTransDetails",
                  dataType:"JSON",
                  method:"POST",
                  cache: false,
                  ...
                  success:function(data){
                    if(empty(data)){
                        ...
                        for (var index = 0; index < ItemDetails.length; index++) {
                            ...
                            var StockVal =   parseFloat(ItemDetails[index].Stock);
                            ...
                            html += "<td id='ItemName"+countof_record+"'>"+ItemDetails[index].ItemName+" <input type='hidden' name='ItemName_val"+countof_record+"' id='ItemName_val"+countof_record+"' value='"+ItemDetails[index].ItemName+"'></td>";
    ...
    // Delete Account
        $('.DeleteBtn').on('click',function(){ 
            var TransID = $('#TransID').val();
            $.ajax({
                url:"<?php echo admin_url(); ?>Stock_transfer/DeleteTransfer",
                dataType:"JSON",
                method:"POST",
                data:{TransID:TransID
                },
    ...
    $("#caexcel").click(function(){
	  act = '1';
        $.ajax({
            url:"<?php echo admin_url(); ?>Stock_transfer/exportGodown",
            method:"POST",
            data:{act:act},
            beforeSend: function () {
                $('#searchh').css('display','block');
