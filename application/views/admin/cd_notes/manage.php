    ...
    <div class="row" style="display:none;">
		<div class="col-md-12">
		    <table id="print_table">
			     <thead>
			         <tr>
			             <th align="center" colspan="13"><?php echo $party_details->PlantName; ?></th>
			         </tr>
			         <tr>
			             <th align="center" colspan="13"><?php echo $party_details->address; ?></th>
			         </tr>
			     </thead>
			    <tbody>
			         <?php
			            if($cd_notes_details->accounts->CustomerType !='1'){
			                $AccountName = $cd_notes_details->accounts->business_name;
			                $GST_Aadhar = $cd_notes_details->accounts->gstin;
			                $address = $cd_notes_details->accounts->address;
			                $state = $cd_notes_details->accounts->GSTState;
                            $state_Short_name = $cd_notes_details->accounts->GstState_short_name;
			            }else{
			                $AccountName = $cd_notes_details->accounts->firstname.' '.$cd_notes_details->accounts->middlename.' '.$cd_notes_details->accounts->lastname;
			                $GST_Aadhar = $cd_notes_details->accounts->aadhaar_number;
			                $address = $cd_notes_details->accounts->house.' '.$cd_notes_details->accounts->street.' '.$cd_notes_details->accounts->loc.''.$cd_notes_details->accounts->po.' '.$cd_notes_details->accounts->subdist.' '.$cd_notes_details->accounts->dist.' '.$cd_notes_details->accounts->state.' - '.$cd_notes_details->accounts->pincode;
			                $state = $cd_notes_details->accounts->state;
                            $state_Short_name = $cd_notes_details->accounts->AState_short_name;
			            }
			         ?>
			         <tr>
			         ...
			         <tr>
			             ...
			             <td colspan="3"><b>Name : </b> <?php echo $AccountName; ?></td>
			             <td colspan="3"><b>Center Name : </b><?php echo $party_details->CenterName; ?></td>
			             <td colspan="4"><b>Mobile : </b><?php echo $cd_notes_details->accounts->AccountID; ?></td>
			         </tr>
			         <tr>
			             <td colspan="3"><b>GSTIN/Aadhar : </b><?php echo $GST_Aadhar; ?></td>
			             <td colspan="3"><b>State : </b> <?php echo $state ?></td>
			             <td colspan="7"><b>Address : </b><?php echo $address; ?></td>
          ...
          <div class="panel-body">
            ...
            <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Credit/Debit Note</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
      ...
      <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <?php
                                        ...
                                        $prefix = "CR".'<span id="prefix_year">'.$fy.'</span>';
                                        $prefix2 = "DB".'<span id="prefix_year">'.$fy.'</span>';
                                        
                                        $_credit_number = str_pad($new_creditNumber, get_option('number_padding_prefixes'), '0', STR_PAD_LEFT);
                                        $_debit_number = str_pad($new_debitNumber, get_option('number_padding_prefixes'), '0', STR_PAD_LEFT);
                                    ?>
                                    <div class="form-group credit_div" style="<?php if(isset($cd_notes_details) && $cd_notes_details->BT=="D"){ echo 'display:none'; }?>">
                                        <label for="number">Credit</label>
                                    ...
                                    <div class="form-group debit_div" style="<?php if((isset($cd_notes_details) && $cd_notes_details->BT=="C") || !isset($cd_notes_details)){ echo 'display:none'; }?>">
                                        <label for="number">Debit</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><?php echo $prefix2; ?></span>
                                ...
                                ?>         
                                    ...
                                    <?php echo render_date_input('credit_note_date','Date',$value,$attr); ?>
                                </div>
                                
                                <div class="col-md-3" >
                                    <label for="act_name">Account GST / Aadhaar</label>
                                    <input type="text" name="gst_no" id="gst_no" class="form-control" value="<?php echo $GST_Aadhar; ?>">
                                </div>
                                <div class="col-md-3" >
                                    <label for="state">State Name</label>
                                    <input type="text" name="state" id="state" class="form-control" value="<?php echo $state; ?>">
                                    <input type="hidden" name="state_short_code" id="state_short_code"  value="<?php echo $state_Short_name; ?>">
                                </div>
                            </div>
                            <!--END First row-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9" >
                                    <label for="account_full_name">Account Name</label>
                                    <input type="text" name="account_full_name" id="account_full_name" class="form-control" value="<?php echo $AccountName; ?>">
                                </div>
                            </div>
                               ...
                               <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <label for="salecd">Against Sales</label>
                                            <input type="radio" id="purchasecd" name="type_cd" class="type_cd" value="purchasecd">
                                            <label for="purchasecd">Against Purchase</label>
                            ...
                            if(isset($cd_notes_details)){
                                ...
                                ?>
                                    <tr id='row<?php echo $i;?>'>
                                        ...
                                        <td style="width:25%" id="item_name<?php echo $i;?>"><?php echo $value["ItemName"]; ?><input type="hidden" name="item_name_val<?php echo $i;?>" id="item_name_val<?php echo $i;?>" value="<?php echo $value["description"]; ?>"></td>
                                        ...
                                        <td style="width:5" align="right" id="sgst<?php echo $i;?>"><?php echo $value["cgst"]; ?><input type="hidden" name="sgst_per_val<?php echo $i;?>" id="sgst_per_val<?php echo $i;?>" value="<?php echo $value["sgst"]; ?>"></td>
            ...
            if(isset($cd_notes_details)){
              ...
              <?php if(has_permission_new('cd_notes','','view')){ ?>
                        ...
                        <div class="col-md-2" >
                            <?php if(has_permission_new('cd_notes','','print')){ ?>
         ...
         <div class="modal-body" style="padding:5px;">
            ...
            <div class="table_cd_report">
                ...
                <thead>
                    ...
                    <tr>
                             <th style="width:1%;">CDID</th>
                             <th style="width:1%;text-align:left;">Type</th>
                             <th style="width:10%;text-align:left;">TransDate</th>
                             <th style="width:1%;text-align:left;">BillID</th>
                             <th style="width:28%;text-align:left;">Account Name</th>
                             <th style="width:10%;text-align:left;">GST / Aadhaar</th>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(var count = 0; count < data.length; count++)
                {
                    ...
                    html += '<td  style="text-align:center;">'+data[count].Transdate+'</td>';
                    html += '<td  style="text-align:center;">'+data[count].TransID+'</td>';
                    html += '<td  style="text-align:left;">'+ data[count].AccountName +'</td>';
                    html += '<td  style="text-align:left;">'+ data[count].GST_Aadhar +'</td>';
                    ...
                    html += '<td style="text-align:right;">'+data[count].BillAmt+'</td>';
                    html += '</tr>';
                }
...
$('#tbody').on('click', '.remove', function () {
  ...
  var item_code =$(this).parents("tr").find('input[name="item_code'+no+'"]').val();
    ...
    var act_state = $("#state_short_code").val();
...
$(document).ready(function(){
    ...
    $('#act_name').on('blur', function () {
        ...
        if(empty(old_AccountID)){
                ...
                $.ajax({
                    ...
                    success: function( data ) {
                        if(empty(data)){
                            ...
                            $('#account_full_name').val(data.AccountName); // display the selected text
                            $('#state').val(data.state); // display the selected text
                            $('#state_short_code').val(data.state_short_code); // display the selected text
            ...
            if(old_AccountID == AccountID){
                ...
                if(Conform == true){
                    $.ajax({
                        url: "<?=base_url()?>admin/sale_return/GetAccountDetailsByID",
                        type: 'post',
                        dataType: "json",
                        data: {
                          AccountID: AccountID,
    ...
    function init_model(item_hsn,act_code)
    {
        ...
        if (typeof (item_code) !== 'undefined') {
            ...
            var html = '';
            requestGetJSON('cd_notes/get_bill_id/' + item_hsn +"/"+ act_code + "/"+CDType).done(function (response) {
                html +=' <thead>';
                if(CDType == "salecd"){
                    ...
                    html +='<th align="center">PurchaseDate</th>';
                ...
                if(CDType == "salecd"){
                    ...
                    if(value.Invoicedate){
                        var invdate = value.Invoicedate.substring(0, 10);
                    }else{
                        var invdate = '';
                    }
                    html +='<tr onclick="get_bill_details(\''+value.PurchID+'\',\''+value.sum_total+'\',\''+value.igst+'\',\''+value.cgst+'\',\''+value.sgst+'\')">';
                    html +='<td align="center">'+value.FY+'</td>';
                    html +='<td align="center"><input type="hidden" name="bill_id">'+value.PurchID+'</td>';
                    html +='<td align="center">'+value.TransDate.substring(0, 10)+'</td>';
                    html +='<td align="center">'+value.Invoiceno+'</td>';
                    html +='<td align="center">'+invdate+'</td>';
                    html +='<td align="right">'+value.BilledQty+'</td>';
                    html +='<td align="right">'+value.final_rate+'</td>';
...
<script>
    ...
    function get_bill_details(bill_id,sum,igst,cgst,sgst){
        ...
        if(igst == "null"){
            ...
            var igstper = parseFloat(igst).toFixed(2);
        }
        if(cgst == "null"){
            var cgstper = '0.00';
        }else{
            var cgstper = parseFloat(cgst).toFixed(2);
        }
        if(sgst == "null"){
            var sgstper = '0.00';
        }else{
            var sgstper = parseFloat(sgst).toFixed(2);
        }
        if(added_trn_id == bill_id || added_trn_id == "" || added_trn_id == null){
            $('#sgst').html(sgstper);
            $('#sgst_per_val').val(sgstper);
            
            $('#cgst').html(cgstper);
            $('#cgst_per_val').val(cgstper);
            
            $('#igst').html(igstper);
            $('#igst_per_val').val(igstper);
