...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-6">
                <div class="panel_s">
                    ...
                    ?>
                    <?php echo render_input('phonenumber','staff_add_edit_phonenumber',$value,'',$attr); ?>
     ...
     <div class="panel_s mtop10  ">
        <div class="panel-body">
           <h4 class="no-margin">
            <?php echo "Center Wise Priority Set"; ?>
        </h4>
        <hr class="hr-panel-heading" />
            <div class="table-center_priority tableFixHead2">
                <?php echo form_open_multipart('admin/staff/SetCenterPriority',array('id'=>'center_priority','autocomplete'=>'off')); ?>
              <table class="tree table table-striped table-bordered table-center_priority tableFixHead2" id="center_priority_table" width="50%">
                <thead>
                    <tr>
                ...
                <?php
                $i = 1;
                foreach($getCenter as $val){
                    $Priority = '';
                    foreach($staffCenterPriority as $value){
                        if($value["CenterID"] == $val["CenterID"]){
                    ...
                    <tr>
                        <td><?php echo $i;?></td>
                        <td><?php echo $val["CenterID"];?></td>
                        <td><?php echo $val["CenterName"];?></td>
                        <td><input type="text" onkeypress="return isNumber(event)" style="height:25px;" name="<?php echo $val["CenterID"];?>" id="<?php echo $val["CenterID"];?>" value="<?php echo $Priority;?>"></td>
                    </tr>
                    <?php
                    $i++;
                }
 ...
 <div class="col-md-6">
    ...
    <div class="panel_s mtop10  ">
        <div class="panel-body">
           <h4 class="no-margin">
            <?php echo "Item Wise Priority Set"; ?>
        </h4>
        <hr class="hr-panel-heading" />
            <div class="table-purchase_request tableFixHead2">
                <?php echo form_open_multipart('admin/staff/SetItemPriority',array('id'=>'staff_profile_table','autocomplete'=>'off')); ?>
              <table class="tree table table-striped table-bordered table-purchase_request tableFixHead2" id="table_purchase_request" width="100%">
                ...
                <?php
                $i = 1;
                foreach($staffItem as $val){
                    $Priority = '';
                    foreach($staffItemPriority as $value){
                        if($value["ItemID"] == $val["ItemID"]){
                            $Priority = $value["priority"];
                        }
                    }
                    ?>
                    <tr>
                        ...
                        <td><input type="text" onkeypress="return isNumber(event)" style="height:25px;" name="<?php echo $val["ItemID"];?>" id="<?php echo $val["ItemID"];?>" value="<?php echo $Priority;?>"></td>
                    </tr>
                    <?php
                    $i++;
                }
