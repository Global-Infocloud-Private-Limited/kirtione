          ...
          <div class="panel-body">
              <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>ItemWise Stock Report</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
            <div class="_buttons">
                <div class="row">
                    ...
                    <div class="col-md-3" >
                        <div class="form-group" app-field-wrapper="ItemID">
                            ...
                            <select name="ItemID" id="ItemID" class="selectpicker form-control" data-none-selected-text="Non Selected" data-live-search="true" >
                                <option value=""></option>
                            <?php
                                foreach ($GetActiveItemList as $key => $value) {
                            ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" app-field-wrapper="GodownID">
                            ...
                            <select name="GodownID" id="GodownID" multiple class="selectpicker form-control" data-none-selected-text="Non Selected" data-live-search="true" <?php echo $GodownStatus;?>>
                                <option value=""></option>
                            <?php
                    ...
                    <div class="col-md-4">
                        <div class="form-group" app-field-wrapper="PartyID">
                            ...
                            <select name="PartyID" id="PartyID" multiple class="selectpicker form-control" data-none-selected-text="Non Selected" data-live-search="true" <?php echo $GodownStatus;?>>
                                <!--<option value="">ALL</option>-->
                            <?php
                    ...
                    <div class="col-md-4">
                        <div class="custom_button" style=" margin-top: 20px;">
                            ...
                            <?php if (has_permission_new('ItemWiseStockReport', '', 'export')) {
                            ?>
                            ...
                            <?php if (has_permission_new('ItemWiseStockReport', '', 'print')) {
                                ?>
    ...
    $('#search_data').on('click',function(){
	    ...
	    if(ItemID == ''){
	        ...
	        $.ajax({
              ...
              method:"POST",
              cache: false,
              data:{from_date:from_date,to_date:to_date,ItemID:ItemID,CenterID:CenterID,
              Service_type:Service_type,GodownID:GodownID,PartyID:PartyID},
              beforeSend: function () {
