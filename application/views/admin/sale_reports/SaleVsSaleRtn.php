        ...
        <div class="panel_s">
          ...
          <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active text-capitalize"><b>Sales Reports</b></li>
    							<li class="breadcrumb-item active" aria-current="page"><b>Sales VS SalesReturn</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
            <div class="_buttons">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="custom_button">
                            ...
                            <?php if (has_permission_new('saleVsSaleRtn', '', 'export')) {
                            ?>
                            ...
                            <?php if (has_permission_new('saleVsSaleRtn', '', 'print')) {
                            ?>
