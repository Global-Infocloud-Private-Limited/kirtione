         ...
         <ul class="nav navbar-nav navbar-left">
            ...
            <?php if(is_client_logged_in()) { ?>
                <li class="dropdown customers-nav-item-profile">
                    ...
                    <ul class="dropdown-menu animated fadeIn">
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('clients/BookingList'); ?>">Trade List</a>
                        </li>
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('clients/CropSell'); ?>">Sale Order List</a>
                        </li>
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('clients/PurchaseOrderList'); ?>">Purchase Order List</a>
                        </li>
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('clients/WHBooking'); ?>">Deposit Order List</a>
                        </li>
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('clients/Withdrawal'); ?>">Withdrawal Order List</a>
                        </li>
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('clients/AnamatList'); ?>">Anamat Order List</a>
                        </li>
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('clients/TradeFinanseList'); ?>">Trade Finanse Order List</a>
                        </li>
                ...
                <li class="dropdown customers-nav-item-profile">
                    ...
                    <ul class="dropdown-menu animated fadeIn">
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('ItemMaster'); ?>">Item Master</a>
                        </li>
                        
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('InwardMaster'); ?>">Inward List</a>
                        </li>
                        
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('PurchaseRequestMaster'); ?>">Purchase Request List</a>
                        </li>
                        
						<!--<li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('SaleOrderMaster'); ?>">Sale Order List</a>
                        </li>-->
                        
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('PurchaseOrderMaster'); ?>">Purchase Order List</a>
                        </li>
                        
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('PurchaseInvoiceMaster'); ?>">Purchase Invoice List</a>
                        </li>
						<li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('StockTransferMaster'); ?>">Stock Transfer List</a>
                        </li>							
                    </ul>
                </li>
                <li class="dropdown customers-nav-item-profile">
                    ...
                    <ul class="dropdown-menu animated fadeIn">
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('K1InventoryMaster'); ?>">Stock Position</a>
                        </li>
                        
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('K1InventoryMaster/ItemWiseStock'); ?>">Itemwise Stock Position</a>
                        </li>
                        
                        <li class="customers-nav-item-edit-profile">
                            <a href="<?php echo site_url('K1InventoryMaster/AsOndateStockReport'); ?>">As On Date Stock</a>
                        </li>
                    </ul>
                </li>
               <li class="dropdown customers-nav-item-profile">
