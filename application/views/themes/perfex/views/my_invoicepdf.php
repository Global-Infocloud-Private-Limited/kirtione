...
foreach ($get_order_list as $key => $order_detail) {
    ...
    if($PlantID == "1"){
        $BankMsg = '<b>Bank A/c Details - CRAZY SNACKS PVT. LTD.<br>1. STATE BANK OF INDIA - A/C - 30634015673, IFSC-SBIN0000086, Bank Road, Gorakhpur <br>2. PUNJAB NATIONAL BANK - A/C - 1875002100047113, IFSC-PUNB0187500, Jubilee Road, Gorakhpur<br>3. UPI Details - 9415212586@kotak</b>';
    }else if($PlantID == "3"){
        if($FY == "22"){
            $BankMsg = '<b>Bank A/c Details - Crazy Bakery Udyog Pvt. Ltd.<br>1. State Bank of India<br>A/C NO. 41039913830, IFSC CODE. SBIN0017640<br>SPL COMMERCIAL BRANCH 
GORAKHPUR.<br> <br><br></b>';
        }else{
            $BankMsg = '<b>Bank A/c Details - CRAZY BAKERY UDYOG<br>STATE BANK OF INDIA<br>SPL COMMERCIAL BRANCH 
GORAKHPUR<br>A/C NO. 40672270054<br>IFSC CODE. SBIN0017640</b>';
        }
    }else{
         $BankMsg = '';
    }
