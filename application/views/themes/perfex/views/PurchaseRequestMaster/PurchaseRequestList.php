    ...
    <div class="panel_s">
        <div class="panel-body">
            <div class="row">
                <nav aria-label="breadcrumb" >
                    <ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><b>Purchase Request List</b></li>
                    </ol>
                </nav>
                <hr class="hr_style">
                <?php
		        ...
		        <div class="col-md-3">
                    <button class="btn btn-info pull-left mleft5 search_data" style="margin-top: 20px;margin-right:5px;" id="search_data">Show</button>
                    <div class="custom_button">
                        ...
                        <a class="btn btn-default" href="javascript:void(0);"  style="margin-top: 20px;margin-left:2px;"  onclick="printPage();">Print</a>
                    </div>
                </div>  
            ...
            <div class="row">
                        ...
                        <table class="table-purchase_request tree table table-bordered OrderList" id="OrderList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;">PurchID</th>
                                    <th style="text-align:center;">PR Date</th>            
                                    <th >Center Name</th>            
                                    <th style="text-align:center;">Purch Amt</th> 
                                    ...
                                    <th style="text-align:center;">Inv Amt</th>                                                     
                                </tr>
                            </thead>
                ...
                <div class="col-md-12">
                    <span id="searchh2" style="display:none;">Loading Please wait..</span>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function(){  
    ...
    function load_data(){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>PurchaseRequestMaster/GetPurchaseRequestList",
            method:"POST",
            data:{from_date:from_date, to_date:to_date,AccountID:AccountID,CenterID:CenterID},
            beforeSend: function () {
...
<script type="text/javascript">
    function printPage()
    {
        ...
        heading_data += '<tr>';
        heading_data += '<td style="text-align:center;"colspan="3">Order Report : From : ' + from_date + ', To : ' + to_date + ', Center Name : ' + center + ' </td>';
        heading_data += '</tr>';  	
