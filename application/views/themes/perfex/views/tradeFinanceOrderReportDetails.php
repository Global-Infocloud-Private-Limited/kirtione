    ...
    <div class="content">
        <div class="row">
            <div class="col-md-8" style="width: 80%; margin: 0 auto;">
                <div class="panel_s" style=" margin: 0 auto;">
                    <div class="panel-body">
                        <div class="clearfix mtop20"></div>
                        <div class="row">
                            <div class="col-md-12">
                                <h4>Trade Fianance Order Details</h4>
                                ...
                                <div class="row" style="margin:auto;width:100%;">
                                    ...
                                    <div class="col-md-12" style="padding:0px;">
                                        <table class="tree table table-striped table-bordered table-purchase_request tableFixHead2" id="table-purchase_request" width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <form id="final_qc_form" method="POST" action="<?php echo base_url(); ?>Clients/saveFinalQC">
