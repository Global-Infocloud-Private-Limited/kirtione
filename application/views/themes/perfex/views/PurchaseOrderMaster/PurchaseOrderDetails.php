            ...
            <div class="row">
                <nav aria-label="breadcrumb" >
                    <ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><b>Purchase Order Details</b></li>
                    </ol>
                </nav>
                <hr class="hr_style">
                
                <div class="col-md-8">
                    <h4><b>Purchase Order Detail</b></h4>
                    <div class="table-purchase_request tableFixHead2">
                        ...
                        <tbody id="for_uppercase">
                            <tr>
                                <td><b>PO.No. : </b></td>
                                <td><?php echo $PurchaseOrderdata->PurchID; ?></td>
                                
                                <td><b>PO Date. : </b></td>
                                <td><?php echo _d($PurchaseOrderdata->Transdate); ?></td>
                            </tr>
                            
                            <tr>
                                <td><b>PR.No. : </b></td>
                                <td><?php echo $PurchaseOrderdata->Pr_no; ?></td>
                                
                                <td><b>PR Date: </b></td>
                                <td><?php echo _d($PurchaseOrderdata->PRDate); ?></td>
                            </tr>
                            
                            <tr>
                                <td><b>Center Name : </b></td>
                                <td><b><?php echo $PurchaseOrderdata->CenterName; ?></b></td>
                                
                                <td><b>Vendor Name : </b></td>
                                <td><?php echo $PurchaseOrderdata->company; ?></td>
                            </tr>
                            
                            <tr>
                                 <td><b>Mobile.No : </b></td>
                                <td><?php echo $PurchaseOrderdata->phonenumber; ?></td>
                                
                                <td><b>State : </b></td>
                                <td><?php echo $PurchaseOrderdata->state_name; ?></td>
                            </tr>
...
$(document).ready(function(){  
    ...
    function load_data(){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>PurchaseOrderMaster/GetPurchOrderDetails",
            method:"POST",
            data:{ID:ID},
            beforeSend: function () {
                $('#OrderList').html('');
