            ...
            <div class="row">
                <nav aria-label="breadcrumb" >
                    <ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><b>Inward List</b></li>
                    </ol>
                </nav>
                <hr class="hr_style">
                <?php
                        ...
                        <table class="table-purchase_request tree table table-bordered OrderList" id="OrderList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;">InwardID</th>
...
$(document).ready(function(){  
    ...
    function load_data(){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>InwardMaster/GetInwardDetailsList", 
            method:"POST",
