...
$(document).ready(function(){  
    ...
    function load_data(){      
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>StockTransferMaster/GetFilterDataStockTransferDetails",
            method:"POST",
            data:{from_date:from_date, to_date:to_date,order_status:order_status,AccountID:AccountID,FromCenterID:FromCenterID,ToCenterID:ToCenterID,ItemID:ItemID,Report_type:Report_type},
            beforeSend: function () {
                $('#OrderList').html('');
            },
...
<script type="text/javascript">
    function printPage()
    {
        ...
        heading_data += '<tr>';
        heading_data += '<td style="text-align:center;"colspan="3">Order Report : From : ' + from_date + ', To : ' + to_date + ', From Center Name : ' + fromcenter + ',To Center Name : ' + tocenter + ', Report Type : ' + reporttype + ', Order Status : ' + orderstatustext + ' </td>';
        heading_data += '</tr>';  	
...
<script>
    ...
    {   		
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>StockTransferMaster/export_StockTransferlist",
            method: "POST",
            data: {order_statusText:order_statusText,FromCenterName,FromCenterName,FromCenterID:FromCenterID,ToCenterID:ToCenterID,ToCenterName:ToCenterName,ReportTypetext:ReportTypetext,ItemName:ItemName,ItemID:ItemID,Report_type:Report_type,AccountID: AccountID, 
                    from_date: from_date, to_date: to_date, order_status: order_status},
            success: function (data) {              
