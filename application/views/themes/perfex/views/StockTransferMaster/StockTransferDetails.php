	 ...
	 <div class="panel-body">
		<div class="row">
            <div class="col-md-12">
		        ...
		        <div>
					<?php 
						if($TransferDetails->OrderStatus == "F")
						{ $orderstat = "Completed";}
					   else if($TransferDetails->OrderStatus == "C")
					   { $orderstat = "Cancelled";}						
					?>
					<table>
						<thead>
							<tr>
								<td width="20%"><strong>Transfer ID</strong></td>
								<td><?php echo $TransferDetails->TransferID;?></td>
							</tr>
							<tr>
								<td width="20%"><strong>Transfer Date</strong></td>
								<td><?php echo _d(substr($TransferDetails->TransferDate,0,10));?></td>
							</tr>
							<tr>
								<td width="20%"><strong>Transfer From</strong></td>
								<td><?php echo $TransferDetails->Fromcenter;?></td>
							</tr>
							<tr>							
								<td width="20%"><strong>Transfer To</strong></td>
								<td><?php echo $TransferDetails->ToCenter;?></td>
							</tr>
							<tr>
								<td width="20%"><strong>AccountID</strong></td>
								<td><?php echo $TransferDetails->AccountID;?></td>
							</tr>
							<tr>
								<td width="20%"><strong>Party Name</strong></td>
								<td><?php echo $TransferDetails->company;?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><?php echo $TransferDetails->TotalOrderQty;?></td>								
							</tr>							
						</thead>						
					</table>	
					...
					<div class="table-purchase_request tableFixHead2" id="first_table_container">
					  <table class="table-purchase_request tree table table-bordered OrderList" id="OrderList" width="100%">
						<table>
							...
							<tbody>
								<?php $sr_no = 1;
								foreach($TransferHistoryDetails as $val):
