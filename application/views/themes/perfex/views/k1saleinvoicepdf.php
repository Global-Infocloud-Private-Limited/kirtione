<?php
	...
	foreach ($get_order_list as $key => $order_detail) {
		...
		// }
		if($order_detail["DeliveryType"] == "1"){
            $DeliveryType = "Pickup";
		}elseif($order_detail["DeliveryType"] == "2"){
        ...
        $html .= '<tr>
        <th style="border-left: 1px solid #333;border-right: 1px solid #333;" width="50%" colspan="2"><b>Ship To</b></th>
        <th style="border-right: 1px solid #333;border-left: 1px solid #333;" width="50%" colspan="2"><b>Ship From</b></th>
        </tr>';
        
        $html .= '<tr>
        <th style="border-left: 1px solid #333;border-right: 1px solid #333;" width="50%" colspan="2">'.$client_detail->company.'</th>
        <th style="border-right: 1px solid #333;border-left: 1px solid #333;" width="50%" colspan="2">'.$order_detail['CenterName'].'</th>
        </tr>';
        $html .= '<tr>
        <th style="border-left: 1px solid #333;border-right: 1px solid #333;" width="50%" colspan="2"><b>'.$client_detail->VendorAddress.'</b></th>
        <th style="border-right: 1px solid #333;border-left: 1px solid #333;" width="50%" colspan="2">'.$order_detail['CenterAddress'].'</th>
        </tr>';
        ...
        <th style="border-right: 1px solid #333;border-left: 1px solid #333;" width="50%" colspan="2">'.$client_details2->company.'</th>
        </tr>';
		...
		$html .= '<tr>
        <th style="border-left: 1px solid #333;border-right: 1px solid #333;" width="50%" colspan="2"></th>
        <th style="border-right: 1px solid #333;border-left: 1px solid #333;" width="50%" colspan="2">Delivery Type : '.$DeliveryType.'</th>
        </tr>';
