            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
						...
						<?php $LogInUser = $this->session->userdata('AccountID'); ?>
...
$(document).ready(function(){
	...
	{
		$.ajax({
				url:"<?php echo base_url(); ?>K1InventoryMaster/GetItemGroupList",
				dataType:"JSON",
				method:"POST",
    ...
    $('#CenterID').on('change',function(){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>K1InventoryMaster/GetGodownListByCenterID",
            dataType:"JSON",
            method:"POST",
    ...
    $('#search_data').on('click',function(){
	    ...
	    if(ItemGroup == "" || ItemGroup== null){
	        ...
	        $.ajax({
                url:"<?php echo base_url(); ?>K1InventoryMaster/GetStockReport",
                dataType:"JSON",
                method:"POST",
                cache: false,
    ...
    $("#caexcel").click(function(){
	    ...
	    if(ItemGroup == "" || ItemGroup== null){
          ...
          $.ajax({
                url:"<?php echo base_url(); ?>K1InventoryMaster/export_stock_report",
                method:"POST",
               data:{from_date:from_date,to_date:to_date,ItemGroup:ItemGroup,
                    CenterID:CenterID,GodownID:GodownID,PartyID:PartyID},
                beforeSend: function () {
