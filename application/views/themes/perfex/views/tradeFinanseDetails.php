...
<div class="row">
            ...
            <div class="row" style="margin:auto;width:100%;">
                <a class="btn btn-info" id="generate_asn" href="<?php echo base_url(); ?>Clients/TradeGenerateAsn/<?php echo $OrderDetails->BookingID; ?>" >Generate ASN</a>
            </div>
        <div class="row">
            <hr>
        </div>
                    ...
                    <table class="tree table table-striped table-bordered table-purchase_request tableFixHead2" id="table-purchase_request" width="100%">
                        ...
                        <tbody>
                            <?php foreach($OrderList as $key=>$value){ ?>
                                <tr class="GetDetails" data-type="<?php echo $value['TType']; ?>" data-asn="<?php echo $value['ASNID']; ?>" data-id="<?php echo $value['id']; ?>">
                                    <?php 
                                    ...
                                    <td><?php echo $value['Asn_WT_MT']; ?></td>
...
<!-- <script>
    $(document).ready(function(){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>Clients/getSingleTrade",
            method: "POST",
            dataType: "JSON",
            data:{
                BookingID: BookingID
