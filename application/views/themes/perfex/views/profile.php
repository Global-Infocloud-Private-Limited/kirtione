...
<div class="row section-heading section-profile">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group profile-firstname-group col-md-6">
							<label for="accountid">Account ID</label>
							<input type="text" class="form-control" name="accountid" id="accountid" value="<?php echo set_value('accountid',$contact->accountid); ?>">
                    ...
                    <div class="col-md-12">
						...
						<div class="form-group profile-lastname-group col-md-6">
						...
						<!-- <div class="form-group profile-positon-group col-md-6">
                    ...
                    <div class="col-md-12">
						<div class="form-group profile-email-group col-md-6">
						...
						<div class="form-group profile-phone-group col-md-6">
							<label for="phonenumber"><?php echo _l('clients_phone'); ?></label>
							<input type="text" class="form-control" name="phonenumber" id="phonenumber" value="<?php echo $contact->phonenumber; ?>" readonly>
						</div>
                    </div>    
                    ...
                    <div class="col-md-12">
                        <div class="form-group profile-phone-group col-md-6">
							...
							<input type="text" class="form-control" name="pan" id="pan" value="<?php echo $contact->pan; ?>">
						</div>
						<div class="form-group contact-direction-option profile-direction-group col-md-6">
	...
	<div class="col-md-4 contact-profile-change-password-section">
		<!-- <div class="panel_s section-heading section-change-password">
			<div class="panel-body">
                <h4 class="no-margin section-text">Bank Account Details</h4>
			</div>
		</div> -->
		<div class="panel_s">
			<div class="panel-body">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="accountname" id="accountname" placeholder="Account Number: ">
                    <?php echo form_error('accountname'); ?>
                </div>
				<div class="form-group">
					<input type="text" class="form-control" name="ifsc" id="ifsc" placeholder="IFSC Number: ">
					<?php echo form_error('ifsc'); ?>
				</div>
                <br><br>

                <label for="bankname"><b>GST Details</b></label>
				<div class="form-group">
					<input type="text" class="form-control" name="ifsc" id="ifsc" placeholder="State: ">
					<?php echo form_error('ifsc'); ?>
				</div>
				<div class="form-group">
					<input type="text" class="form-control" name="ifsc" id="ifsc" placeholder="Business Name: ">
					<?php echo form_error('ifsc'); ?>
				</div>
				<div class="form-group">
					<input type="text" class="form-control" name="ifsc" id="ifsc" placeholder="Address: ">
					<?php echo form_error('ifsc'); ?>
				</div>
				<!-- <div class="form-group">
					<button type="submit" class="btn btn-info btn-block">Change Details</button>
				</div> -->
				<?php echo form_close(); ?>
			</div>
