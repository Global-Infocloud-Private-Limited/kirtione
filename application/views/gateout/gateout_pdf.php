...
$pdf->SetTitle($GateOutDetails->BookingID);
...
if(isset($GateOutDetails)){
    foreach($GateOutDetails as $k=>$v)
    {
        $gate_in = _d($v['gate_in_date']);
        $gate_out = _d($v['gate_out_date']);
        $w_name = $v['w_name'];
        $GodownID = $v['GodownID'];
        ...
        $html = '
            <table style="width: 100%; font-size:12px;font-weight:700;" cellspacing="1" cellpadding="6" border="0.1">
                ...
                <tr>
                    <td style="width: 100%;text-align:center; font-size:14px;font-weight:700;"><b>GATE OUT PASS</b></td>
                </tr>
                <tr>
                ...
                <tr>    
                    ...
                    <td style="width:25%; ">'.$gate_in.'</td>
                    <td style="width:25%; "><b>GateOut Time: </b></td>
                    <td style="width:24.7%; ">'.$gate_out.'</td>
                </tr>
                <tr style="display:none">
                    ...
                    <td style="width:17%; "><b>Sales &nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px;font-weight:bold;'.$scss.'">&#x2713;</span></b></td>
                    <td style="width:16%; "><b>Purchase &nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px;font-weight:bold;'.$pcss.'">&#x2713;</span></b></td>
            ...
            $html .= '<tr>
                ...
                <tr>
                    ...
                    <td style="width: 24.7%; ">'.number_format($ASNWt, 3, '.', '').' MT</td>
                </tr>';
            ...
            if($transaction_type !== 'Sales'){
                $html .= '
                    ...
                    <tr>
                        ...
                        <td style="width: 70%; ">'.$StackDetails->ChamberName.'</td>
                    </tr>
                    <tr>
                        <td style="width: 30%; "><b>Stack Name </b></td>
                        <td style="width: 70%; ">'.$StackDetails->StackName.'</td>
                    </tr>
                    <tr>
                        <td style="width: 30%; "><b>Lot Name </b></td>
                        <td style="width: 70%; ">'.$StackDetails->LotName.'</td>
                    </tr>';
            }
            
            $html .= '<tr>
                    <td style="width: 30%; "><b>No of Bags </b></td>
                    <td style="width: 70%; ">'.$StackDetails->bags.'</td>
                </tr>
...
$dir = $_SERVER['DOCUMENT_ROOT']."uploads/gateout_print/".$BookingID."/"; // full path like C:/xampp/htdocs/file/file/
if (!file_exists($dir)) {
    mkdir($dir, 0777, true);
}
$filename = $dir.$Gate_in_ID.'.pdf';
ob_clean();
