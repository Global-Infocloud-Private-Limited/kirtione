...
class Sale_return_model extends App_Model
{
    ...
    public function update_sale_return($data){
        ...
        $this->db->update(db_prefix() . 'salesreturn', $update_record);
            ...
            $get_lastamount = $this->get_last_ledger_amt($data["ex_sale_return_id"],$data['old_act_name']);
        ...
        // Delete previous Old AccoutID ledger
            ...
            $get_lastamount2 = $this->get_last_ledger_amt($data["ex_sale_return_id"],$data['act_name']);
        ...
        $get_account_bal3 = $this->get_acc_bal("SALE");
        $get_lastamount3 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"SALE");
        ...
        // Delete previous SALE ledger
            ...
            $ord_no++;
            $get_account_bal4 = $this->get_acc_bal("SALE");
            $get_lastamount4 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"SALE");
        ...
        if($data['account_state']=="UP"){
            ...
            $get_lastamount55 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"IGST");
            
            $current_bal55 = $get_account_bal55->$mm_old;
            ...
            $get_lastamount5 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"SGST");
            ...
            $get_lastamount6 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"SGST");
        ...
        // ledger & balances for CGST 
            ...
            $get_lastamount7 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"CGST");
            
            $current_bal7 = $get_account_bal7->$mm_old;
            ...
            $get_lastamount8 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"CGST");
        ...
        // credit previous cgst amount 
            ...
            $get_lastamount99 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"CGST");
            
            $current_bal99 = $get_account_bal99->$mm_old;
            ...
            $debit_pre_ledger_amt33 = $current_bal99 - $debited_amt33;
                ...
                $this->db->where('AccountID', "CGST");
                $this->db->update(db_prefix() . 'accountbalances', [
                                            $mm_old => $debit_pre_ledger_amt33,
                                        ]);
        // credit previous Sgst amount 
            $get_account_bal999 = $this->get_acc_bal("SGST");
            $get_lastamount999 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"SGST");
            
            $current_bal999 = $get_account_bal999->$mm_old;
            ...
            $debit_pre_ledger_amt333 = $current_bal999 - $debited_amt333;
                ...
                $this->db->where('AccountID', "SGST");
                $this->db->update(db_prefix() . 'accountbalances', [
                                            $mm_old => $debit_pre_ledger_amt333,
                                        ]);
                                        
        // ledger & balances for IGST 
            // credit IGST ledger &  balance    
            $get_account_bal9 = $this->get_acc_bal("IGST");
            $get_lastamount9 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"IGST");
            
            $current_bal9 = $get_account_bal9->$mm_old;
            ...
            $get_lastamount10 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"IGST");
            ...
            $get_lastamount11 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"ROUNDOFF");
        
            $current_bal11 = $get_account_bal11->$mm_old;
            ...
            if($get_lastamount11->TType == "C"){
                ...
                $this->db->update(db_prefix() . 'accountbalances', [
                                            $mm_old => $credited_pre_ledger_amt_rdf,
                                        ]);
            if($get_lastamount11){
                $ledger_audit = array(
        ...
        if($rnd_amt > 0 || $rnd_amt < 0){
            ...
            $get_lastamount12 = $this->get_last_ledger_amt($data["ex_sale_return_id"],"ROUNDOFF");
    ...
    //end balance and ledger entry code
        ...
        $salertn_details = $this->get_salertn_details($data["old_act_name"],$data["ex_sale_return_id"]);
        ...
        if($data["old_act_name"] == $data["act_name"]){
            for($i=1; $i<$count; $i++) {
                ...
                $this->db->where('OrderID', $data["ex_sale_return_id"]);
                $this->db->update(db_prefix() . 'history', $edit_date);
            ...
            // Stock value update sale return
            $salertn_details = $this->get_salertn_details($data["old_act_name"],$data["ex_sale_return_id"]);
            foreach ($salertn_details as $key => $value) {
                    # code...
                //$stock_data = $this->get_stock_item($value['ItemID']);
        ...
        // END Stock value update sale return
        }else{
