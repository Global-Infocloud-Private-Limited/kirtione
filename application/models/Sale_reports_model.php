...
class Sale_reports_model extends App_Model
{
    ...
    public function GetActiveItemList()
    {
        ...
        $this->db->where('tblitems.PlantID', $PlantID);
    ...
    public function GetItemWiseStockReport($filterdata)
    {
        ...
        $this->db->select('tblhistory.TransDate2,tblhistory.CenterID,tblhistory.GodownID,tblhistory.PartyID,tblhistory.TType,tblhistory.TType2,tblhistory.TypeID,
        ...
        $this->db->group_by('tblhistory.TType,tblhistory.TType2,DATE(tblhistory.TransDate2)');
    ...
    public function GetPartyItemWiseBodyData($filterdata)
     { 
        ...
        if($TransType =='1'){
            ...
            $sql1 = 'SELECT '.db_prefix() . 'history.*,'.db_prefix() . 'items.description,Sum('.db_prefix() . 'history.NetChallanAmt) AS ItemValue,Sum('.db_prefix() . 'history.BilledQty) AS BilledQty FROM '.db_prefix() . 'history 
            INNER JOIN tblitems ON tblitems.item_code=tblhistory.ItemID AND tblitems.PlantID = tblhistory.PlantID 
            WHERE '.db_prefix() . 'history.FY = '.$fy.'  AND '.db_prefix() . 'history.PlantID = '.$selected_company.'
            AND tblhistory.TType IN("O") AND tblhistory.AccountID = "'.$AccountID.'" 
            AND tblhistory.TransDate2 BETWEEN "'.$from_date.' 00:00:00" AND "'.$to_date.' 23:59:59" 
            ...
            $sql2 = 'SELECT '.db_prefix() . 'history.*,'.db_prefix() . 'items.description,Sum('.db_prefix() . 'history.NetChallanAmt) AS ItemValue,Sum('.db_prefix() . 'history.BilledQty) AS BilledQty FROM '.db_prefix() . 'history 
            INNER JOIN tblitems ON tblitems.item_code=tblhistory.ItemID AND tblitems.PlantID = tblhistory.PlantID 
            WHERE '.db_prefix() . 'history.FY = '.$fy.'  AND '.db_prefix() . 'history.PlantID = '.$selected_company.'
            AND tblhistory.TType = "R" AND tblhistory.TType2 = "Fresh" AND tblhistory.AccountID = "'.$AccountID.'" 
            AND tblhistory.TransDate2 BETWEEN "'.$from_date.' 00:00:00" AND "'.$to_date.' 23:59:59" 
            ...
            $sql3 = 'SELECT '.db_prefix() . 'history.*,'.db_prefix() . 'items.description,Sum('.db_prefix() . 'history.NetChallanAmt) AS ItemValue,Sum('.db_prefix() . 'history.BilledQty) AS BilledQty FROM '.db_prefix() . 'history 
            INNER JOIN tblitems ON tblitems.item_code=tblhistory.ItemID AND tblitems.PlantID = tblhistory.PlantID 
            WHERE '.db_prefix() . 'history.FY = '.$fy.'  AND '.db_prefix() . 'history.PlantID = '.$selected_company.'
            AND tblhistory.TType IN("R","D") AND tblhistory.TType2 = "Damage" AND tblhistory.AccountID = "'.$AccountID.'" 
            AND tblhistory.TransDate2 BETWEEN "'.$from_date.' 00:00:00" AND "'.$to_date.' 23:59:59" 
    ...
    public function get_itemdetails_for_sale_return2($AccountId,$filterdata)
     { 
        ...
        $sql = 'SELECT SUM(NetChallanAmt) as sr_amt_sum,AccountID,ItemID,SUM(tblhistory.BilledQty / tblhistory.CaseQty) AS sr_sumcases,SUM(tblhistory.BilledQty) AS sr_sumunit  
        FROM `tblhistory` 
    ...
    public function get_itemdetails_for_body_data($AccountId,$filterdata)
     { 
        ...
        $sql = 'SELECT SUM(NetChallanAmt) as amt_sum,AccountID,ItemID,SUM(tblhistory.BilledQty / tblhistory.CaseQty) AS sumcases,SUM(tblhistory.BilledQty) AS sumunit,tblhistory.SuppliedIn  FROM `tblhistory` WHERE TransDate2 BETWEEN "'.$from_date.' 00:00:00" AND "'.$to_date.' 23:59:59" AND AccountID IN('.$AccountId.') AND PlantID = '.$selected_company.' AND FY = "'.$fy.'"';
