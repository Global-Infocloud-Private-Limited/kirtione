...
*
*/
define('APP_BASE_URL', 'https://kirti.globalinfocloud.in/');
 ...
 */
define('APP_DB_USERNAME', 'kirti2ginf9_er_pusr7');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'W%f53!X@B0oq');
//define('APP_DB_PASSWORD', ')$^j.BXki2eJ123');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'kirti2ginf9_erp_db_k');
