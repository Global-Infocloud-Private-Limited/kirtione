...
function Saleinvoice_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/Saleinvoice_pdf', $invoice, $tag);
}
function DirectSaleinvoice_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/DirectSaleinvoice_pdf', $invoice, $tag);
}
function B2BSaleinvoice_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/B2BSaleinvoice_pdf', $invoice, $tag);
}
function Deliveryinvoice_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/Deliveryinvoice_pdf', $invoice, $tag);
}

function Commission_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/Commission_pdf', $invoice, $tag);
}
...
function k1gatepass_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/k1gatepass_pdf', $invoice, $tag);
}
/**
