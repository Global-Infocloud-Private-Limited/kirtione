...
function get_dashboard_widgets()
{
    $widgets = [
        ...
        [
            'path'      => 'admin/dashboard/widgets/SaleDashboard2',
            'container' => 'top2-12',
        ],
        ...
        [
            'path'      => 'admin/dashboard/widgets/CenterCommodityWisePurchase',
            'container' => 'left-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/CenterCommodityWiseDeposit',
            'container' => 'right-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/CenterCommodityWisePurchaseStock',
            'container' => 'left-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/CenterCommodityWiseDepositStock',
            'container' => 'right-6',
        ],
        /*[
            'path'      => 'admin/dashboard/widgets/CenterWiseTradeStatus',
            'container' => 'left-6',
        ],*/
        /*[
        ...
        [
            ...
            'container' => 'left-bottom-8',
        ],
        [
            'path'      => 'admin/dashboard/widgets/todos',
            'container' => 'right-bottom-4',
        ],
        /*[
        ...
        [
            'path'      => 'admin/dashboard/widgets/TradeTypeCenterWiseReport',
            'container' => 'right-4',
        ],
        [
            'path'      => 'admin/dashboard/widgets/Accessthetraderandfarmerandsales',
            'container' => 'right-4',
        ],
        /*[
