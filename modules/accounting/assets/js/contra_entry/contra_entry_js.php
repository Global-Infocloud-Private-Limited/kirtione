...
(function($) {
  ...
  <?php }else{ ?>
  	data = [
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","dr_cr":"","debit":"","credit":"","description":""},
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","dr_cr":"","debit":"","credit":"","description":""},
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","dr_cr":"","debit":"","credit":"","description":""},
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","dr_cr":"","debit":"","credit":"","description":""},
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","dr_cr":"","debit":"","credit":"","description":""},
  ...
  <?php } ?>
    ...
    var commodity_type = new Handsontable(hotElement1, {
      ...
      colWidths: [50, 200, 100, 100, 30, 40, 30, 50, 50, 130],
      rowHeights: 10,
      rowHeaderWidth: [20],
      columns: [
                {
        ...
        changes.forEach(([row, prop, oldValue, newValue]) => {
            ...
            if(prop == 'AccountID'){
                ...
                if(newValue !== '' || newValue !== null){
                    ...
                    commodity_type.setDataAtCell(row,7,''); 
                    commodity_type.setDataAtCell(row,8,''); 
                    commodity_type.setDataAtCell(row,9,''); 
                }
            }
        });
    ...
    $('.contra-entry-form-submiter').on('click', function() {
      ...
      var total_debit = 0, total_credit = 0;
	    $.each(contra_entry, function(index, value) {
        if(value[7] != '' && value[7] != null){
          total_debit += parseFloat(value[7].toFixed(2));
        }
        if(value[8] != '' && value[8] != null){
          total_credit += parseFloat(value[8].toFixed(2));
        }
      });
...
function customDropdownRenderer1(instance, td, row, col, prop, value, cellProperties) {
  ...
  if(selectedId == "C"){
      instance.setCellMeta(row,7,'readOnly',true);
      instance.setCellMeta(row,8,'readOnly',false);
  }
  if(selectedId == "D"){
      instance.setCellMeta(row,8,'readOnly',true);
      instance.setCellMeta(row,7,'readOnly',false);
  }
