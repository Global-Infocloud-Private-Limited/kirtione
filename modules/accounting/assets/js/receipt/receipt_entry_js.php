...
(function($) {
  ...
  <?php }else{ ?>
  	data = [
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","debit":"","cheque_no":"","description":""},
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","debit":"","cheque_no":"","description":""},
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","debit":"","cheque_no":"","description":""},
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","debit":"","cheque_no":"","description":""},
              {"AccountID":"","company":"","center":"","commodity":"","entryfor":"","party":"","debit":"","cheque_no":"","description":""},
  ...
  <?php } ?>
    ...
    let accountList = {};
    let accountCache = {};
    var isEditMode = <?php echo isset($receipts_entry) ? 'true' : 'false'; ?>;
    var commodity_type = new Handsontable(hotElement1, {
        ...
        colWidths: [50, 200, 50, 50, 30, 40, 50, 50, 130],
        rowHeights: 10,
        rowHeaderWidth: [20],
        data: data,
        ...
        afterChange: (changes) => {
            if(changes != null){
                changes.forEach(([row, prop, oldValue, newValue]) => {
                    ...
                    if (prop == 'cheque_no') {
                        //var AccountID = commodity_type.setDataAtCell(row, 1);
                        var cheque_no = commodity_type.getDataAtCell(row, 7);
                        //console.log('cell value =>', cheque_no);
                        // $.post(admin_url + 'accounting/checkChequeExists', {
                        //     cheque_no: cheque_no
