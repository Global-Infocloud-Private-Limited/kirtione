        ...
        <div class="panel-body">
                        <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Payment</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
          <?php $arrAtt = array();
          ...
          <div class="row">
            ...
            if($selected_company == 1){
                $new_paymentNumber = get_option('next_payment_number_for_kirti');
            }
            ?>
              <?php $value = (isset($payment_entry) ? $payment_entry->VoucherID : ''); ?>
            ...
            <div class="col-md-1" style="margin-top: 20px;">
              ...
              <a href="<?php echo admin_url('accounting/delete_payment_entry/' . $payment_entry->VoucherID) ?>" class="btn btn-danger <?php echo $return;?>">Delete</a>
                <?php
                    }
                ?>
          </div>
...
$(document).ready(function(){
  ...
  function load_data(from_date,to_date)
  {
    $.ajax({
      ...
      success:function(data){
        ...
        for(var count = 0; count < data.length; count++)
        {
          ...
          var url = "'<?php echo admin_url() ?>accounting/payment_entry/"+data[count].VoucherID+"'";
    ...
    <?= isset($payment_entry) ? '' : 'fetchNextVoucherNumber();';?>
});
    ...
    function fetchNextVoucherNumber() {
        ...
        $('input[name="payment_number"]').val('Loading...');
