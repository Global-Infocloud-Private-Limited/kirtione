              ...
              <div id="collapse1" class="panel-collapse collapse in">
                <ul class="list-group">
                  <li class="list-group-item">
                    ...
                    <div class="col-md-6">
                      <a href="<?php echo admin_url('accounting/balancesheet'); ?>" target="_blank"><h4 class="no-margin"><?php echo _l('balance_sheet_comparison'); ?></h4></a>
                  ...
                  <li class="list-group-item">
                    <div class="row">
                     <div class="col-md-6">
                      ...
                      <a href="<?php echo admin_url('accounting/voucher_register'); ?>"><h4 class="no-margin"><?php echo "Voucher Register"; ?></h4></a>
