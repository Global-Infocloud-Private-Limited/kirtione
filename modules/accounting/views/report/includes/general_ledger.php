          ...
          <div class="row">
            <div class="col-md-10">
              ...
              <?php //echo form_open(admin_url('accounting/view_report2'),array('id'=>'filter-form')); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group" app-field-wrapper="accounting_method">
                        <label for="accounting_method" class="control-label">Select Party</label>
                        <select name="plant_id" id="plant_id" class="selectpicker" data-width="100%" data-none-selected-text="All" data-live-search="true">
                            <option value="All">All</option>
                            <?php 
                            foreach ($all_parties as $value) {
                                 ?>
                                    <option value="<?php echo $value["PlantID"]; ?>" <?php if($value["PlantID"] == "KASPL"){ echo 'selected';}?>><?php echo $value["PlantName"] ?></option>
                                 <?php
                               }
                            ?>
                        </select>
