      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="row">
            ...
            <?php echo form_open('admin/accounting/trialbalance', array('id' => 'filter_item_form')); ?>
                        ...
                        ?>
                          ...
                          ?>
                            ...
                            <tr class="treegrid-<?php echo html_entity_decode($Counter3); ?> treegrid-parent-<?php echo $Counter2; ?> parent-node " id="Accounts">
                              ...
                              <td class="parent onclick-cursor" onclick="RedirectLedger('<?php echo strtoupper($val3['AccountID']); ?>')"><?php echo $val3["AccountName"]; ?></td>
