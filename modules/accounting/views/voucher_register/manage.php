        ...
        <div class="panel-body">
          ...
          <div class="row">
           ...
           // echo render_select( 'states',$states,array( 'short_name','state_name'), 'client_state','',array('data-none-selected-text'=>_l('dropdown_non_selected_tex')));
            ...
            <div class="col-md-2">
                <label for="is_reconciled" class="control-label">Is Reconciled</label>
                <select class="form-control" id="is_reconciled">
            ...
            <div class="4">
                ...
                <div class="custom_button">
                    <?php if (has_permission_new('accounting_voucher_register_entry', '', 'export')) {
                    ?>
                    ...
                    <?php if (has_permission_new('accounting_voucher_register_entry', '', 'print')) {
                    ?>
...
$(document).ready(function(){
    $('#search_data').on('click',function(){
	    ...
	    var is_reconciled = $("#is_reconciled").val();
	   ...
	   $.ajax({
          ...
          method:"POST",
          cache: false,
          data:{from_date:from_date, to_date:to_date, voucher_type:voucher_type, is_reconciled:is_reconciled},
          beforeSend: function () {
