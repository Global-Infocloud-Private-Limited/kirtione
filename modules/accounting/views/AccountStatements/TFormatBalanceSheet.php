		...
		<div class="panel-body">
			...
			<div class="row ">
				...
				<div class="col-md-10">
					...
					?>
						&nbsp;&nbsp;
						<a class="btn btn-default" href="javascript:void(0);" style="<?php echo $ShowHideBtn; ?>" onclick="printPage();">Print</a>
					<?php } ?>
					...
					<?php } ?>
					&nbsp;&nbsp;
					<label class="" style="<?php echo $ShowHideBtn; ?>">
											...
											<table class="tree">
												<thead>
													<tr class="tr_header" id="tr_header">
														<th style="text-align:center;font-weight: 400;font-size: 16px;" colspan="3"><?php echo $CurrentYrFirstDate . ' - ' . $from_date; ?></th>
													</tr>
													<tr class="tr_header" id="tr_header">
														<th style="text-align: left;font-weight: 500;font-size: 16px;">Particular</th>
														<th style="text-align: right;font-weight: 500;font-size: 16px;" class="th_total" colspan="2">Amount(₹)</th>
													</tr>
												</thead>
												...
												<tbody>
													...
													?>
														<tr class="treegrid-<?php echo $MainCounter; ?> parent-node expanded" id="maingroup">
															<td class="parent" style="font-size:15px;font-weight:500;"><?php echo $val['MainGroup']; ?></td>
															<td></td>
															<td></td>
														</tr>
														<?php
														...
														?>
															<tr class="treegrid-<?php echo html_entity_decode($SubCounter); ?> treegrid-parent-<?php echo $MainCounter; ?> parent-node  "
																id="subgroup">
																<td class="parent" style="font-size:14px;font-weight:500;"><?php echo strtoupper($val1["SubGroup1Name"]); ?></td>

																<td style="text-align:right;font-size:14px;font-weight:500;"></td>
																<td style="text-align:right;font-size:14px;font-weight:500;"><?php echo number_format($val1['Group1ClsBal'], 2, '.', ''); ?></td>
															</tr>
															...
															?>
																<tr
																	...
																	<td style="text-align:left;font-weight:400;font-size:13px;" class="parent"><?php echo strtoupper($val2["SubGroupName"]); ?></td>
																	<td style="text-align:right;font-weight:400;font-size:13px;"></td>
																	<td style="text-align:right;font-weight:400;font-size:13px;"><?php echo number_format($val2["Group2ClsBal"], 2, '.', ''); ?></td>
																...
																foreach ($val2['Accounts'] as $key3 => $val3) {
																	...
																	if ($val3['AccountClsBal'] == 0) {
																		continue;
																	}
																?>
																	<tr class="treegrid-<?php echo html_entity_decode($Counter3); ?> treegrid-parent-<?php echo $Counter2; ?> parent-node " id="Accounts" onclick="RedirectLedger('<?php echo strtoupper($val3["AccountID"]); ?>')">
																		<td style="text-align:left;font-weight:400;font-size:12px;" class="parent" style="cursor:pointer;"><?php echo strtoupper($val3["AccountName"]); ?></td>
																		<td style="text-align:right;font-weight:400;font-size:12px;"></td>
																		<td style="text-align:right;font-weight:00;font-size:12px;"><?php echo number_format($AccountBal, 2, '.', ''); ?></td>
															...
															?>
																	<tr id="maingroup_bottom">
																		<th style="font-size:15px;font-weight:500;">Total for <?php echo $val['MainGroup']; ?></th>
																		<th colspan="2" style="text-align:right;font-size:15px;font-weight:500;">
												...
												<tbody>
													...
													?>
															...
															?>
																<tr class="treegrid-<?php echo html_entity_decode($SubCounter); ?> treegrid-parent-<?php echo $MainCounter; ?> parent-node  "
																	id="subgroup">
																	<td class="parent" style="font-size:14px;font-weight:400;"><?php echo strtoupper($val1["SubGroup1Name"]); ?></td>

																	<td style="text-align:right;font-size:14px;font-weight:400;"></td>
																	<td style="text-align:right;font-size:14px;font-weight:400;"><?php echo number_format($val1['Group1ClsBal'], 2, '.', ''); ?></td>
																</tr>
																...
																?>
																	...
																	?>
																		<tr class="treegrid-<?php echo html_entity_decode($Counter3); ?> treegrid-parent-<?php echo $Counter2; ?> parent-node " id="Accounts" onclick="RedirectLedger('<?php echo strtoupper($val3["AccountID"]); ?>')">
																			<td style="text-align:left;font-weight:400;font-size:12px;" class="parent"><?php echo strtoupper($val3["AccountName"]); ?></td>
																			<td style="text-align:left;font-weight:400;font-size:12px;"></td>
																			<td style="text-align:right;font-weight:400;font-size:12px;"><?php echo number_format($AccountBal, 2, '.', ''); ?></td>
