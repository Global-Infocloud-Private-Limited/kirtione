   ...
   <div class="content">
      <div class="row">
         <div class="col-md-8">
               ...
               <div class="panel-body">
                    ...
                    <div class="row">
                       <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <?php echo render_select('TDSID',$TDSList,array('TDSCode','TDSName'),'TDS Code','',''); ?>
                        </div>
            ...
            <div class="col-md-6">
                <?php
                    if (has_permission_new('accounting_tds_report', '', 'print')) {
                ?>
              ...
              <table class="tree table table-striped table-bordered table-daily_report tableFixHead2" id="table-daily_report" width="100%">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th style="text-align:left;">TDS Description</th>
                    <th style="text-align:left;">Posting Data</th>
                    <th style="text-align:center;">From</th>
                    <th style="text-align:center;">Doc Number</th>
                    <th style="text-align:center;">Supplier Name</th>
                    <th style="text-align:center;">Supplier PAN</th>
...
<?php init_tail(); ?>
 ...
 <script>
  ...
  function load_data(from_date,to_date,tdsID)
  {
    $.ajax({
      url:"<?php echo admin_url(); ?>accounting/load_data_for_tds",
      dataType:"html",
      method:"POST",
      data:{from_date:from_date, to_date:to_date,tdsID:tdsID},
      beforeSend: function () {
 ...
 $('#search_data').on('click',function(){
	    ...
	    $(".report_for").text(msg);
        load_data(from_date,to_date,tdsID);
 });
 ...
 <script>
    ...
    $("#caexcel").click(function(){
	   ...
	   var to_date = $("#to_date").val();
	    var tdsID = $("#TDSID").val();
	    $.ajax({
            url:"<?php echo admin_url(); ?>accounting/export_tds_report",
            method:"POST",
            data:{from_date:from_date, to_date:to_date,tdsID:tdsID},
            beforeSend: function () {
 ...
 function printPage(){
    ...
    var tableData = '<table  border="1" cellpadding="0" cellspacing="0" width="100%" class="tree table table-striped table-bordered" style="font-size:12px;">'+document.getElementsByTagName('table')[0].innerHTML+'</table>';
        var heading_data = '<table  border="1" cellpadding="0" cellspacing="0" width="100%" class="tree table table-striped table-bordered" style="font-size:12px;"><tbody><tr><td style="text-align:center;" colspan="3"><?php echo $company_detail->company_name; ?></td></tr><tr><td style="text-align:center;" colspan="3"><?php echo $company_detail->address; ?></td></tr>';
         heading_data += '<tr>';
         heading_data += '<td style="text-align:center;"colspan="3">TDS Report  '+html_filter_name+'</td>';
         heading_data += '</tr>';
