                   ...
                   <nav aria-label="breadcrumb" >
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="subgroup_code">ActSubGroupID2</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                            <label for="subgroup_name">ActSubGroupName2</label>
                    ...
                    <div class="row">
                       <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                             <?php if (has_permission_new('account_monitor_report', '', 'export')) {
                            ?>
                                ...
                                <div class="table-AccountSubgroup tableFixHead2">
                                    <table class="tree table table-striped table-bordered table-AccountSubgroup tableFixHead2" id="table_AccountSubgroup" width="100%">
                                        <thead>
                                            ...
                                            <tr>
                                                <th>AccountSubGroupID</th>
                                                <th>AccountSubGroupName</th>
                                                <th>AccountSubGroupName1</th>
                                                <th>AccountMainGroupName</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        foreach ($ActGroupData as $key => $value) {
                                        ?>
                                            <tr class="get_AccountID" data-id="<?php echo $value["SubActGroupID"]; ?>">
                                                ...
                                                <td><?php echo $value["ActMainGroupName"];?></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>   
