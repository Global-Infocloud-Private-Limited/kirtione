        ...
        <div class="panel-body">
                        <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b>Receipts</b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
          <?php $arrAtt = array();
          ...
          <div class="row">
            ...
            ?>
              <?php $value = (isset($receipts_entry) ? $receipts_entry->VoucherID : ''); ?>
...
$(document).ready(function(){
    <?= isset($receipts_entry) ? '' : 'fetchNextVoucherNumber();';?>
