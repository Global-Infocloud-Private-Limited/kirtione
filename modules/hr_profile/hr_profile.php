...
function hr_profile_load_js(){    
	...
	function hr_profile_permissions()
	{
		...
		//Hr Profile
// 		register_staff_capabilities('hrm_hr_records', $capabilities01, 'Add Edit Staff','HR');
// 		register_staff_capabilities('hrm_hr_records', $capabilities, 'Add Edit Staff','HR');
// 		register_staff_capabilities('hrm_hr_sub_admin', $capabilities01, 'Add Edit Sub-Admin','HR'); 
// 		register_staff_capabilities('hrm_hr_sub_admin', $capabilities, 'Add Edit Sub-Admin','HR');
// 		register_staff_capabilities('hrm_hr_recordslist', $onlyview01, 'Staff List','HR');
// 		register_staff_capabilities('hrm_hr_recordslist', $onlyview, 'Staff List','HR');
		//HR Expenses
// 		register_staff_capabilities('cliam_expenses', $onlyview01, 'Claim Expenses','HR');
// 		register_staff_capabilities('cliam_expenses', $claim, 'Claim Expenses','HR');
		//Job Description
// 		register_staff_capabilities('staffmanage_job_position', $capabilities01, "Job Designation",'HR');
		//Training
