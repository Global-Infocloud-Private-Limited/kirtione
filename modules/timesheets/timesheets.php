...
{  
	$CI = &get_instance();
	if (
	   // has_permission_new('attendance_management', '', 'view_own') ||
...
function timesheets_permissions()
{
    ...
    // Only View and Print
    $onlyView_print_export['capabilities'] = [
		'view' => _l('permission_view') . '(' . _l('permission_global') . ')',
...
// 	register_staff_capabilities('attendance_management', $onlyView_export, _l('attendance_sheet'),'HR');
...
// 	register_staff_capabilities('leave_management', $capabilities01, _l('leave_management'),'HR');
...
// 	register_staff_capabilities('table_shiftwork_management', $capabilities02, _l('shift_management'),'HR');
...
// 	register_staff_capabilities('timesheets_shift_type', $capabilities02, _l('shift_type'),'HR');
...
// 	register_staff_capabilities('timesheet_report', $onlyView_print_export, "Timesheet Reports",'HR');
	// Workplace
	$capabilities['capabilities'] = [
		'view_own' => _l('permission_view'),
		'view' => _l('permission_view') . '(' . _l('permission_global') . ')',
