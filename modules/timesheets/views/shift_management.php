					...
					<div class="panel-body">
					    <nav aria-label="breadcrumb" >
    						<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    							...
    							<li class="breadcrumb-item active" aria-current="page"><b><?php echo html_entity_decode($title); ?></b></li>
    						</ol>
    					</nav>
    					<hr class="hr_style">
						<div class="row">
							<div class="col-md-12">
								...
								<div>
									<div class="_buttons">
										<?php if (has_permission('table_shiftwork_management', '', 'create') || is_admin()) { ?>
